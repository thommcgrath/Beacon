	...
	<body<?php if ($noNavigation) { echo ' class="no-navigation"'; } ?>>
		<div id="header_wrapper">
			<div id="header" class="pagebody">
				...
				<div id="header_links_cell"><ul><li><a id="menu_explore_link" href="#">Explore</a></li><li><a id="menu_download_link" href="/download">Download</a></li><li><a id="menu_support_link" href="https://help.usebeacon.app/">Help</a></li><li><a id="menu_buy_link" href="/omni">Buy</a></li></ul></div>
			</div>
		</div>

	...
	<body style="margin: 0px; font-family: Helvetica, sans-serif;">
		...
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
			...
			<tr style="font-size: 14px;">
				<td>&nbsp;</td>
				<td width="300" style="padding: 30px 15px 30px 30px;" align="left">This email was sent to <?php echo htmlentities($recipient); ?> because it was requested from <a href="https://usebeacon.app">https://usebeacon.app</a>.</td>

...
class BeaconLogin {
	...
	public function Show(): void {
		...
		echo "<script>\n";
		echo "var device_id = " . json_encode(BeaconCommon::DeviceID()) . ";\n";
		echo "</script>";
...
<div id="page_totp">
	<form id="login_form_totp" method="post">
		<p>Your account is protected by two factor authentication. Please enter the code generated by your authenticator app.</p>

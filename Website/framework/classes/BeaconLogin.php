...
<div id="page_noscript" class="noscript">
	<?php static::OutputNoscriptMessage() ?>
</div>
<div id="page_loading" class="scriptonly">
...
<div id="page_totp" class="scriptonly">
	<form id="login_form_totp" action="/account/noscript" method="post">
...
<div id="page_recover" class="scriptonly">
...
<div id="page_verify" class="scriptonly">
	...
	<form id="login_verify_form" action="/account/noscript" method="post">
...
<div id="page_password" class="as-new-user scriptonly">
	...
	<form id="login_password_form" action="/account/noscript" method="post">

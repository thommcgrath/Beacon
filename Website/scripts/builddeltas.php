...
function DataForVersion(int $version, $since) {
	return array(
		'loot_sources' => BeaconLootSource::GetAll(0, $since, true),
		'loot_source_icons' => BeaconLootSourceIcon::GetAll(0, $since, true),
		'engrams' => BeaconEngram::GetAll(0, $since, true),
		'presets' => BeaconPreset::GetAll(0, $since, true),
		'preset_modifiers' => BeaconPresetModifier::GetAll(0, $since, true),
		'creatures' => BeaconCreature::GetAll(0, $since, true),
		'diets' => BeaconDiet::GetAll(0, $since, true),
		'help_topics' => BeaconHelpTopic::GetAll($since),
		'game_variables' => BeaconGameVariable::GetAll($since),
		'mods' => BeaconMod::GetLive(),
		'deletions' => BeaconObject::Deletions(0, $since),
		'ini_options' => BeaconConfigLine::GetAll(0, $since),
		'spawn_points' => BeaconSpawnPoint::GetAll(0, $since),

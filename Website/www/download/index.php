...
?><p class="notice-block notice-info">Support for Ark: Survival Ascended requires Beacon 2.0 Alpha 3 or later. You can download this preview version from <a href="#preview">the Preview section below</a>.</p>

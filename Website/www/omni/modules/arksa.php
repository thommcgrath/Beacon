<?php OutputGameHeader('The free version of Beacon supports most <span class="game-name">Ark: Survival Ascended</span> features, with a \'<span class="license-name">Beacon Omni for Ark: Survival Ascended</span>\' license available to unlock all features.', 'ArkSA'); ?>

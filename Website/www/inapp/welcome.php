...
<div id="page_intro">
	...
	<div id="welcome_choices">
		<p><button id="welcome_continue_button" class="default">Continue</button></p>
...
<div id="page_loading">
	<p><img id="loading_spinner" class="white-on-dark" src="/assets/images/spinner.svg" width="64"></p>
</div>
<div id="overlay"></div>
<div id="dialog">
	<div id="dialog_inner">

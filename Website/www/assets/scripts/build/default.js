...
class ExplorePopover {
  ...
  static search(terms) {
    ...
    BeaconWebRequest.get("/search?".concat(params.toString()), {
  ...
  static displayResults() {
    ...
    var resultsContainer = document.getElementById('explore_results');
...
_defineProperty(ExplorePopover, "container", null);
_defineProperty(ExplorePopover, "popover", null);
_defineProperty(ExplorePopover, "field", null);
_defineProperty(ExplorePopover, "link", null);
_defineProperty(ExplorePopover, "searchMoreURL", '');

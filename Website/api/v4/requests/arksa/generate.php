...
use BeaconAPI\v4\ArkSA\Generator;
...
function handleRequest(array $context): Response {
	...
	if ($project->GameId() !== 'ArkSA') {
		return Response::NewJsonError('Project is not an Ark: Survival Ascended project.', null, 400);
	}
	...
	$originalIni = '';
	if ($context['routeKey'] === 'PUT /arksa/projects/{projectId}/Game.ini') {

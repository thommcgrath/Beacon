...
class GenericObject extends DatabaseObject implements JsonSerializable {
	...
	public static function BuildDatabaseSchema(): DatabaseSchema {
		...
		return new DatabaseSchema('arksa', 'objects', [
			new DatabaseObjectProperty($prefix . 'Id', ['primaryKey' => true, 'columnName' => 'object_id']),
			new DatabaseObjectProperty($prefix . 'Group', ['accessor' => 'arksa.table_to_group(SUBSTRING(%%TABLE%%.tableoid::regclass::TEXT, 7))', 'columnName' => 'object_group', 'editable' => DatabaseObjectProperty::kEditableNever]),
	...
	public static function Deletions(int $min_version = -1, DateTime $since = null): array {
		...
		$database = BeaconCommon::Database();
		$columns = 'object_id, arksa.table_to_group(from_table) AS from_table, label, min_version, action_time, tag';

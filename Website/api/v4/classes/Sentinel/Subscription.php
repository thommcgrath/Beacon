...
class Subscription extends DatabaseObject implements JsonSerializable {
	...
	public static function BuildDatabaseSchema(): DatabaseSchema {
		return new DatabaseSchema('sentinel', 'subscriptions', [
			...
			new DatabaseObjectProperty('usedServices', ['columnName' => 'used_services', 'accessor' => '(SELECT COUNT(service_id) FROM sentinel.services WHERE services.subscription_id = %%TABLE%%.subscription_id)', 'required' => false, 'editable' => DatabaseObjectProperty::kEditableNever]),

...
class BeaconSpawnPoint extends BeaconBlueprint {
	...
	protected static function SQLColumns() {
		...
		$columns[] = '(SELECT array_to_json(array_agg(row_to_json(limits_template))) FROM (SELECT creature_id, max_percentage FROM spawn_point_limits WHERE spawn_point_limits.spawn_point_id = spawn_points.object_id) AS limits_template) AS spawn_limits';
		return $columns;
	}

...
ZirconTemplate::SetTitle('Beacon');
...
$mode = MODE_NA;
$hero_name = 'HeroMac';
if (ZirconPlatforms::IsMacOS()) {
	$mode = MODE_MAC;
} elseif (ZirconPlatforms::IsWindows()) {
	$mode = MODE_WIN;
...
<div class="articlebody">
	...
	<p class="text-center"><a href="/beacon/gettingstarted/">Getting Started</a> | <a href="/beacon/documents.php/1616b43c-9efd-4441-bfc2-bb153185216a">Sample Document</a> | <a href="why.php">Why does Beacon do this?</a></p>
	<div class="push">&nbsp;</div>
	<?php switch ($mode) {
	case MODE_NA: ?>
	...
	<?php break;
	case MODE_MAC: ?>
	<p class="text-center"><a href="<?php echo $mac_url; ?>" class="button">Download for <?php echo $mac_label; ?></a><br><a href="<?php echo $win_url; ?>" class="download-alternate">Or Download for <?php echo $win_label; ?></a></p>
	<?php break;
	case MODE_WIN: ?>
	<p class="text-center"><a href="<?php echo $win_url; ?>" class="button">Download for <?php echo $win_label; ?></a><br><a href="<?php echo $mac_url; ?>" class="download-alternate">Or Download for <?php echo $mac_label; ?></a></p>
	<?php break;
	} ?>

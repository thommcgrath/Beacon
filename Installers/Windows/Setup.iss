...
#ifdef x64
  #define MyAppVersion Trim(GetFileProductVersion("..\..\Project\Builds - Beacon.xojo_project\Windows 64 bit\Beacon\Beacon.exe"))
#else
  #define MyAppVersion Trim(GetFileProductVersion("..\..\Project\Builds - Beacon.xojo_project\Windows\Beacon\Beacon.exe"))
#endif

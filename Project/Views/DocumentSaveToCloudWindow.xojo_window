...
#tag Events ActionButton
	#tag Event
		Sub Action()
		  ...
		  Var NewURL As String = Beacon.ProjectURL.TypeCloud + "://" + BeaconAPI.URL("/" + Self.mController.Project.APIPathComponent + "/project/" + Self.mController.Project.UUID).Middle(8)

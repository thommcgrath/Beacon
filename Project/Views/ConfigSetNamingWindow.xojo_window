...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ...
		  Self.Title = Self.MessageLabel.Text
		End Sub
	#tag EndEvent


	#tag Method, Flags = &h21
		Private Sub Constructor(CurrentSetName As String)
		  Self.mCurrentSetName = CurrentSetName
		  Super.Constructor

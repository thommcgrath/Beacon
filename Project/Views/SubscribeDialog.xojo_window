...
#tag Events AddressField
	#tag Event
		Sub TextChange()
		  ...
		  Var Matches As RegExMatch = Regex.Search(Me.Text.Trim)
...
#tag Events ActionButton
	#tag Event
		Sub Action()
		  ...
		  Var FormString As String = "email=" + EncodeURLComponent(AddressField.Text.Trim) + "&first_name=" + EncodeURLComponent(FirstNameField.Text.Trim) + "&last_name=" + EncodeURLComponent(LastNameField.Text.Trim)

...
Inherits BeaconSubview
	...
	#tag Method, Flags = &h1
		Protected Sub OpenTemplate(Template As Beacon.Template)
		  RaiseEvent OpenTemplate(Template)
		End Sub
	#tag EndMethod


	#tag Hook, Flags = &h0
		Event CloseTemplate(Template As Beacon.Template) As Boolean
	#tag EndHook
	...
	#tag Hook, Flags = &h0
		Event OpenTemplate(Template As Beacon.Template)
	#tag EndHook

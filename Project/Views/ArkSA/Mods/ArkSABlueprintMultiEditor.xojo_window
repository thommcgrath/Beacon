...
#tag WindowCode
	#tag Event
		Sub Opening()
		  ...
		  If Mask = ArkSA.Maps.UniversalMask Then
	...
	#tag Method, Flags = &h21
		Private Function Save() As Boolean
		  ...
		  If Self.AllMapsRadio.Value Then
		    AddMask = ArkSA.Maps.UniversalMask
		    ClearMask = 0
		  Else
		    AddMask = ArkSA.Maps.MaskForMaps(Self.MapSelector.CheckedMaps)
		    ClearMask = ArkSA.Maps.MaskForMaps(Self.MapSelector.UncheckedMaps)
		  End If

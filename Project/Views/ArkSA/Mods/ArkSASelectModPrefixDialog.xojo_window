#tag DesktopWindow
Begin BeaconDialog ArkSASelectModPrefixDialog
   Backdrop        =   0
   ...
   Begin DesktopLabel MessageLabel
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Beacon has found blueprints from multiple mods"
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   20
   ...
   Begin DesktopLabel ExplanationLabel
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Choose the mods that you would like to import."
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   52
...
#tag WindowCode
	#tag Method, Flags = &h21
		Private Sub Constructor(Importer As ArkSA.BlueprintImporter)
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, Importer As ArkSA.BlueprintImporter) As String()
		  Var ChosenTags() As String
		  If Parent Is Nil Then
		    Return ChosenTags
		  End If
		  
		  Var Win As New ArkSASelectModPrefixDialog(Importer)

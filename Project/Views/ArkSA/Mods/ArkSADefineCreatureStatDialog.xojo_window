...
Begin BeaconDialog ArkSADefineCreatureStatDialog
   ...
   Begin UITweaks.ResizedPopupMenu StatMenu
      ...
      Width           =   145
   End
   Begin UITweaks.ResizedTextField BaseField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      ...
      Width           =   145
   End
   Begin UITweaks.ResizedTextField WildField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
      ...
      Width           =   145
   End
   Begin UITweaks.ResizedTextField TamedField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
      ...
      Width           =   145
   End
   Begin UITweaks.ResizedTextField AddField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
      ...
      Width           =   145
   End
   Begin UITweaks.ResizedTextField AffinityField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub Constructor(UsedStats As UInt16, Values As ArkSA.CreatureStatValue)
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, UsedStats As UInt16, Values As ArkSA.CreatureStatValue = Nil) As ArkSA.CreatureStatValue
		  ...
		  Var Stat As ArkSA.Stat = Win.StatMenu.RowTagAt(Win.StatMenu.SelectedRowIndex)
		  Return New ArkSA.CreatureStatValue(Stat, CDbl(Win.BaseField.Text), CDbl(Win.WildField.Text), CDbl(Win.TamedField.Text), CDbl(Win.AddField.Text), CDbl(Win.AffinityField.Text))
		End Function
	#tag EndMethod
	...
	#tag Property, Flags = &h21
		Private mUsedStats As UInt16
	#tag EndProperty

	#tag Property, Flags = &h21
		Private mValues As ArkSA.CreatureStatValue
	#tag EndProperty
		...
		Sub Pressed()
		  ...
		  For Each Field As DesktopTextField In Fields
		    ...
		    If IsNumeric(Value) = False Then
		      ...
		      Case Self.WildField
		        FieldLabel = "Wild Multiplier"
		      Case Self.TamedField
		        FieldLabel = "Tamed Multiplier"
		      Case Self.AddField
		        FieldLabel = "Reward Multiplier"
		      Case Self.AffinityField
		        FieldLabel = "Effectiveness Multiplier"
		      End Select

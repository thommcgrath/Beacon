#tag DesktopWindow
Begin BeaconDialog ArkSALootTemplateModifierEditor
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   CloseButton     =   False
   Composite       =   False
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub Constructor(Template As ArkSA.MutableLootTemplate, EditModifierID As String)
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, Template As ArkSA.MutableLootTemplate, EditModifierID As String = "") As Boolean
		  If Parent = Nil Then
		    Return False
		  End If
		  
		  Var Win As New ArkSALootTemplateModifierEditor(Template, EditModifierID)

#tag DesktopWindow
Begin BeaconDialog ArkSASpawnPointReplacementsDialog
   Backdrop        =   0
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, Mods As Beacon.StringList, SpawnSet As ArkSA.MutableSpawnPointSet, TargetCreature As ArkSA.BlueprintReference = Nil) As ArkSA.BlueprintReference
		  ...
		  Var Win As New ArkSASpawnPointReplacementsDialog(Mods, SpawnSet, TargetCreature)
	...
	#tag Property, Flags = &h21
		Private mSpawnSet As ArkSA.MutableSpawnPointSet
	#tag EndProperty

...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub Constructor(Mods As Beacon.StringList, Limit As NullableDouble, SelectedCreatures() As ArkSA.Creature, DefinedCreatures() As ArkSA.Creature, CreaturesInSpawnPoint() As ArkSA.Creature)
		  ...
		  Var SelectableCreatures() As ArkSA.Creature
		  ...
		  End If 
		  For Each Creature As ArkSA.Creature In DefinedCreatures
		  ...
		  For Each Creature As ArkSA.Creature In CreaturesInSpawnPoint
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, Mods As Beacon.StringList, Limit As NullableDouble, SelectedCreatures() As ArkSA.Creature, DefinedCreatures() As ArkSA.Creature, CreaturesInSpawnPoint() As ArkSA.Creature) As NullableDouble
		  If Parent = Nil Then
		    Return Nil
		  End If
	...
	#tag Property, Flags = &h21
		Private mSelectableCreatures() As ArkSA.Creature
	#tag EndProperty
	...
	#tag Event
		Sub Opening()
		  If Self.mDisableSelection Then
		    ...
		    Me.Enabled = False
		  Else
		    For Each Creature As ArkSA.Creature In Self.mSelectableCreatures
		      If Creature Is Nil Then
		        #if TargetMacOS
		          Me.AddSeparator
		        #endif

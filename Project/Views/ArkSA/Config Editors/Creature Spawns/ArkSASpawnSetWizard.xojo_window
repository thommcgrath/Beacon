#tag DesktopWindow
Begin BeaconDialog ArkSASpawnSetWizard
   Backdrop        =   0
...
#tag WindowCode
		  ...
		  For Each Override As ArkSA.MutableSpawnPointOverride In Overrides
		    ...
		    If Override.Mode = ArkSA.SpawnPointOverride.ModeAppend Then
		      ...
		      If (Official Is Nil) = False Then
		        Var Template As New ArkSA.MutableSpawnPointOverride(Official, ArkSA.SpawnPointOverride.ModeOverride, False)
	...
	#tag Method, Flags = &h21
		Private Sub Constructor(Organizer As ArkSA.SpawnSetOrganizer, Mods As Beacon.StringList)
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, Organizer As ArkSA.SpawnSetOrganizer, Mods As Beacon.StringList) As Boolean
		  If Parent = Nil Or Organizer = Nil Then
		    Return False
		  End If
		  
		  Var Win As New ArkSASpawnSetWizard(Organizer, Mods)
	...
	#tag Property, Flags = &h21
		Private mOrganizer As ArkSA.SpawnSetOrganizer
	#tag EndProperty
	...
	#tag Event
		Sub Pressed()
		  ...
		  If Radius = 0 Or (MinPackSize = 1 And MaxPackSize = 1) Then
		    ...
		    Entries.Add(New ArkSA.MutableSpawnPointSetEntry(Self.mSelectedCreature))
		  Else
		    ...
		    For PackNum As Integer = 1 To MaxPackSize
		      Var Entry As New ArkSA.MutableSpawnPointSetEntry(Self.mSelectedCreature)
		  ...
		  Var Set As ArkSA.MutableSpawnPointSet = Self.mOrganizer.Template

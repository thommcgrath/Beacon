#tag DesktopWindow
Begin BeaconContainer ArkSALootEntryPropertiesEditor
   AcceptFocus     =   "False"
   AcceptTabs      =   "True"
...
#tag WindowCode
	#tag Method, Flags = &h0
		Sub ApplyTo(ParamArray Entries() As ArkSA.MutableLootItemSetEntry)
		  Self.ApplyTo(Entries)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub ApplyTo(Entries() As ArkSA.MutableLootItemSetEntry)
	...
	#tag Method, Flags = &h0
		Sub Setup(Entries() As ArkSA.LootItemSetEntry)
		  ...
		  Var Filtered() As ArkSA.LootItemSetEntry
		  ...
		  If Filtered.Count = 0 Then
		    ...
		    Entry.Add(New ArkSA.LootItemSetEntryOption(ArkSA.Engram.CreateCustom("", "/Game/Mods/Default.Default", ""), 1.0))
		    Filtered.Add(Entry)
		  End If
		  Entries = Filtered
		  Filtered = Nil
	...
	#tag Method, Flags = &h0
		Sub Setup(ParamArray Entries() As ArkSA.LootItemSetEntry)
		  Self.Setup(Entries)
		End Sub
	#tag EndMethod
		  ...
		  If Not Self.mIgnoreChanges Then
		    ...
		    Case Self.ModeIndexGuided
		      If Self.mUseCustomQualities Then
		        ...
		        Self.MinQualityMenu.SelectByTag(ArkSA.Qualities.ForBaseValue(Self.CustomMinQualityField.DoubleValue).BaseValue)
		        Self.MaxQualityMenu.SelectByTag(ArkSA.Qualities.ForBaseValue(Self.CustomMaxQualityField.DoubleValue).BaseValue)
		      End If

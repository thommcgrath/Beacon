...
#tag Events EntryPropertiesEditor1
	...
	#tag Event
		Sub WantsResize(NewSize As Integer)
		  Me.Top = Self.SettingsGroup.Top + (36 - ArkSALootEntryPropertiesEditor.Margins)
		  Self.SettingsGroup.Height = NewSize + (56 - (ArkSALootEntryPropertiesEditor.Margins * 2))
		  Me.Height = NewSize
		  
		  Me.Left = Self.SettingsGroup.Left + (20 - ArkSALootEntryPropertiesEditor.Margins)
		  Me.Width = Self.SettingsGroup.Width - (40 - (ArkSALootEntryPropertiesEditor.Margins * 2))

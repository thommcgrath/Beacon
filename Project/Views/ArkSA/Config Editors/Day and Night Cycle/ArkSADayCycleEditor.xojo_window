#tag DesktopWindow
Begin ArkSAConfigEditor ArkSADayCycleEditor
...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As ArkSA.Configs.DayCycle
		  Return ArkSA.Configs.DayCycle(Super.Config(ForWriting))
		End Function
	#tag EndMethod

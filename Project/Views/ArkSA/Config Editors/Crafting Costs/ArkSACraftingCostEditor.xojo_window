#tag DesktopWindow
Begin BeaconContainer ArkSACraftingCostEditor
   AcceptFocus     =   "False"
   AcceptTabs      =   "True"
...
#tag WindowCode
	#tag Method, Flags = &h21
		Private Sub ShowAddResources()
		  ...
		  Var NewEngrams() As ArkSA.Engram = ArkSABlueprintSelectorDialog.Present(Self, "Resources", Engrams, RaiseEvent GetActiveMods, ArkSABlueprintSelectorDialog.SelectModes.ExplicitMultiple)
		...
		Private Sub UpdateList()
		  ...
		  For Idx As Integer = 0 To Self.List.RowCount - 1
		    If Self.List.RowSelectedAt(Idx) Then
		      Var Ingredient As ArkSA.CraftingCostIngredient = Self.List.RowTagAt(Idx)
		  ...
		  For Idx As Integer = 0 To Self.mTarget.LastIndex
		    Var Ingredient As ArkSA.CraftingCostIngredient = Self.mTarget.Ingredient(Idx)
	...
	#tag Property, Flags = &h21
		Private mTarget As ArkSA.MutableCraftingCost
	#tag EndProperty
	...
	#tag ComputedProperty, Flags = &h0
		...
		#tag Setter
			Set
			  ...
			  Self.mTarget = New ArkSA.MutableCraftingCost(Value)
			  Self.UpdateList()
			  Self.Enabled = True
			End Set
		#tag EndSetter
		Target As ArkSA.CraftingCost
...
#tag Events List
	...
	#tag Event
		Sub PerformClear(Warn As Boolean)
		  Var RowsToDelete() As ArkSA.CraftingCostIngredient
		  Var Names() As String
		  ...
		  For Each Ingredient As ArkSA.CraftingCostIngredient In RowsToDelete
		...
		Sub CellAction(row As Integer, column As Integer)
		  ...
		  Case Self.ColumnQuantity
		    ...
		    Catch Err As RuntimeException
		      ...
		      Return
		    End Try
		    Ingredient = New ArkSA.CraftingCostIngredient(Ingredient.Reference, Max(Quantity, 0), Ingredient.RequireExact)
		  Case Self.ColumnRequireExact
		    Ingredient = New ArkSA.CraftingCostIngredient(Ingredient.Reference, Ingredient.Quantity, Me.CellCheckBoxValueAt(Row, Column))
		  Else
		    Return
		  End Select

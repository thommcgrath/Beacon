#tag DesktopWindow
Begin ArkSAConfigEditor ArkSAGeneralSettingsEditor
   ...
   Begin OmniBar ConfigToolbar
      ...
      Width           =   484
   End
   Begin ArkSASettingsListContainer List
      AllowAutoDeactivate=   True
      AllowFocus      =   False
      AllowFocusRing  =   False
      AllowTabs       =   True
...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As ArkSA.Configs.OtherSettings
		  Return ArkSA.Configs.OtherSettings(Super.Config(ForWriting))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub SettingChanged(Key As ArkSA.ConfigOption, NewValue As Variant)
		  Var Config As ArkSA.Configs.OtherSettings = Self.Config(True)
...
#tag Events List
	...
	#tag EndEvent
	#tag Event
		Function GetConfig(ForWriting As Boolean) As ArkSA.Configs.OtherSettings

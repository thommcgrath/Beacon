#tag DesktopWindow
Begin BeaconDialog ArkSAExperienceLevelEditor
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   CloseButton     =   False
   Composite       =   False
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub Constructor(Level As Integer, CurrentXP As UInt64, MinXP As UInt64, MaxXP As UInt64)
		  ...
		  Self.mMaxXP = Min(MaxXP, ArkSA.Configs.ExperienceCurves.MaxSupportedXP)
		  Super.Constructor
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, Level As Integer, ByRef LevelXP As UInt64, MinXP As UInt64, MaxXP As UInt64) As Boolean
		  Var Win As New ArkSAExperienceLevelEditor(Level, LevelXP, MinXP, MaxXP)

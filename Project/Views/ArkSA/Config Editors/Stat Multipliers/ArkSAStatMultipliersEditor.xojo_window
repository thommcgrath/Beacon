#tag DesktopWindow
Begin ArkSAConfigEditor ArkSAStatMultipliersEditor
   ...
   Begin DesktopPagePanel PagePanel1
      ...
      Begin UITweaks.ResizedLabel CreatureStatLabel
         ...
         Width           =   78
      End
      Begin ArkSACreatureStatContainer WildCreatureStats
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
         ...
         Width           =   251
      End
      Begin ArkSACreatureStatContainer TamedCreatureStats
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
         ...
         Width           =   251
      End
      Begin ArkSACreatureStatContainer TamedAddCreatureStats
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
         ...
         Width           =   251
      End
      Begin ArkSACreatureStatContainer TamedAffinityCreatureStats
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
      ...
      Begin UITweaks.ResizedTextField MutagenTamedField
         ...
         Width           =   80
      End
      Begin UITweaks.ResizedTextField MutagenBredField
         AllowAutoDeactivate=   True
         AllowFocusRing  =   True
         AllowSpellChecking=   False
         AllowTabs       =   False
...
#tag WindowCode
	...
	#tag Event
		Sub SetupUI()
		  ...
		  Var Stats() As ArkSA.Stat = ArkSA.Stats.All
		  Var Config As ArkSA.Configs.StatMultipliers = Self.Config(False)
		  For Each Stat As ArkSA.Stat In Stats
		    Self.MutagenTamedField(Stat.Index).Text = Config.MutagenTamedLevels(Stat).ToString(Locale.Current, "0")
		    Self.MutagenBredField(Stat.Index).Text = Config.MutagenBredLevels(Stat).ToString(Locale.Current, "0")
		  Next Stat
		End Sub
	#tag EndEvent
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As ArkSA.Configs.StatMultipliers
		  Return ArkSA.Configs.StatMultipliers(Super.Config(ForWriting))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub UpdateCreatureMenu()
		  ...
		  Var SelectedCreature As ArkSA.Creature
		  ...
		  Var Health As ArkSA.Stat = ArkSA.Stats.Health
		  Var Creatures() As ArkSA.Blueprint = ArkSA.DataSource.Pool.Get(False).GetBlueprints(ArkSA.CategoryCreatures, "", Self.Project.ContentPacks, Nil)
		  For Each Blueprint As ArkSA.Blueprint In Creatures
		    If Not Blueprint IsA ArkSA.Creature Then
		      Continue
		    End If
		    
		    Var Creature As ArkSA.Creature = ArkSA.Creature(Blueprint)
		    If Creature.StatsMask = 0 Or Creature.StatBaseValue(Health) = ArkSA.Creature.MissingStatValue Then
		      Continue
		    End If
	...
	#tag Method, Flags = &h21
		Private Sub UpdateCreatureStats(OnlyStatIndex As Integer = -1)
		  ...
		  Var Creature As ArkSA.Creature = Self.CreatureMenu.RowTagAt(Self.CreatureMenu.SelectedRowIndex)
		  Var Config As ArkSA.Configs.StatMultipliers = Self.Config(False)
		  ...
		  Self.WildCreatureStats.UpdateFigures(ArkSA.Creature.KeyWild, Config, Creature, OnlyStatIndex, Self.SettingUp, False, True)
		  Self.TamedCreatureStats.UpdateFigures(ArkSA.Creature.KeyTamed, Config, Creature, OnlyStatIndex, Self.SettingUp, True, False)
		  Self.TamedAddCreatureStats.UpdateFigures(ArkSA.Creature.KeyAdd, Config, Creature, OnlyStatIndex, Self.SettingUp, False, False)
		  Self.TamedAffinityCreatureStats.UpdateFigures(ArkSA.Creature.KeyAffinity, Config, Creature, OnlyStatIndex, Self.SettingUp, True, False)
		End Sub
	#tag EndMethod
		...
		Private Sub UpdatePlayerUI(OnlyStatIndex As Integer = -1)
		  ...
		  For Each Stat As ArkSA.Stat In Stats
		    ...
		    If BaseField <> Nil And Focus <> BaseField Then
		      ...
		      End If
		      BaseField.Text = ArkCreatureStatContainer.FormatStat(BaseAmount)
		    ElseIf BaseLabel <> Nil Then
		      BaseLabel.Text = Stat.PlayerBase.PrettyText(2)
		    End If
		    
		    If PerLevelAmountLabel <> Nil Then
		      PerLevelAmountLabel.Text = ArkCreatureStatContainer.FormatStat(Stat.PlayerPerLevelAmount) + If(Stat.IsPercentage, "%", "") + " x"
		    End If
		    
		    If PerLevelMultiplierField <> Nil And Focus <> PerLevelMultiplierField Then
		      PerLevelMultiplierField.Text = ArkCreatureStatContainer.FormatStat(Config.PlayerPerLevelMultiplier(Stat))
		    ElseIf PerLevelMultiplierLabel <> Nil Then
		      PerLevelMultiplierLabel.Text = ArkCreatureStatContainer.FormatStat(Config.PlayerPerLevelMultiplier(Stat))
		    End If
		    ...
		    If PerLevelComputedLabel <> Nil Then
		      ...
		      PerLevelComputedLabel.Text = "= " + ArkCreatureStatContainer.FormatStat(PerLevelAmount) + If(Stat.IsPercentage, "%", "")
...
#tag Events WildCreatureStats
	#tag Event
		Sub MultiplierUpdated(StatIndex As Integer, Value As Double)
		  Self.Config(True).WildPerLevelMultiplier(ArkSA.Stats.WithIndex(StatIndex)) = Value
		  Self.Modified = True
		  Self.UpdateCreatureStats(StatIndex)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events TamedCreatureStats
	#tag Event
		Sub MultiplierUpdated(StatIndex As Integer, Value As Double)
		  Self.Config(True).TamedPerLevelMultiplier(ArkSA.Stats.WithIndex(StatIndex)) = Value
		  Self.Modified = True
		  Self.UpdateCreatureStats(StatIndex)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events TamedAddCreatureStats
	#tag Event
		Sub MultiplierUpdated(StatIndex As Integer, Value As Double)
		  Self.Config(True).TamedAddMultiplier(ArkSA.Stats.WithIndex(StatIndex)) = Value
		  Self.Modified = True
		  Self.UpdateCreatureStats(StatIndex)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events TamedAffinityCreatureStats
	#tag Event
		Sub MultiplierUpdated(StatIndex As Integer, Value As Double)
		  Self.Config(True).TamedAffinityMultiplier(ArkSA.Stats.WithIndex(StatIndex)) = Value
		  Self.Modified = True
		  Self.UpdateCreatureStats(StatIndex)
		End Sub
	#tag EndEvent

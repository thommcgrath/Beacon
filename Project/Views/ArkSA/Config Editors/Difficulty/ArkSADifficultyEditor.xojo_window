#tag DesktopWindow
Begin ArkSAConfigEditor ArkSADifficultyEditor
...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As ArkSA.Configs.Difficulty
		  Return ArkSA.Configs.Difficulty(Super.Config(ForWriting))
		End Function
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub FillReferenceFields(Difficulty As ArkSA.Configs.Difficulty)
		  Var DifficultyOffset As Double = 1.0
		  
		  Self.LootScaleField.Text = Difficulty.DifficultyValue.ToString(Locale.Current, "#,##0%")
		  Self.DifficultyValueField.Text = Difficulty.DifficultyValue.PrettyText(ArkSA.Configs.Difficulty.DecimalPlaces, True)
		  Self.DifficultyOffsetField.Text = DifficultyOffset.ToString(Locale.Current, "0.0")
		  Self.OverrideOfficialDifficultyField.Text = Difficulty.OverrideOfficialDifficulty.PrettyText(ArkSA.Configs.Difficulty.DecimalPlaces, True)
...
#tag Events MaxDinoLevelField
	#tag Event
		Sub TextChanged()
		  ...
		  Var Config As ArkSA.Configs.Difficulty = Self.Config(False)

#tag DesktopWindow
Begin ArkSAServerViewContainer ArkSAMultiServerView
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub Constructor(Project As ArkSA.Project, Profiles() As ArkSA.ServerProfile)
	...
	#tag Method, Flags = &h1
		Protected Sub Constructor(Project As ArkSA.Project, Profile As ArkSA.ServerProfile)

#tag DesktopWindow
Begin ArkSAServerViewContainer ArkSAASAManagerServerView
...
#tag WindowCode
	...
	#tag Event
		Sub Opening()
		  Self.ToggleThread.DebugIdentifier = "ArkSAASAManagerServerView.ToggleThread"
		  Self.RefreshThread.DebugIdentifier = "ArkSAASAManagerServerView.RefreshThread"
		End Sub
	#tag EndEvent
	...
	#tag Method, Flags = &h21
		Private Shared Function StatusFromHTTPCode(HTTPStatus As Integer) As String
		  ...
		  Else
		    #if DebugBuild
		      System.DebugLog("ASA Manager status " + HTTPStatus.ToString)
		    #endif
...
#tag Events RefreshThread
	#tag Event
		Sub Run()
		  ...
		  Var Provider As New ASAManager.HostingProvider

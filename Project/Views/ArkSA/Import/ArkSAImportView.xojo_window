...
Begin DocumentImportView ArkSAImportView
   ...
   Begin DesktopPagePanel Views
      ...
      Begin FTPDiscoveryView FTPView
         ...
         Width           =   720
      End
      Begin ArkSAFilesDiscoveryView FilesView
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
      ...
      Begin UITweaks.ResizedPushButton StatusActionButton
         ...
         Width           =   80
      End
      Begin ArkSAClipboardDiscoveryView ClipboardView
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
...
#tag WindowCode
	...
	#tag Event
		Sub Discover(Profiles() As Beacon.ServerProfile)
		  ...
		  For Idx As Integer = Self.mIntegrations.FirstRowIndex To Self.mIntegrations.LastIndex
		    If (Profiles(Idx) IsA ArkSA.ServerProfile) = False Then
		      Continue
		    End If
		    
		    Var Integration As New ArkSA.DiscoverIntegration(Self.mDestinationProject, Profiles(Idx))
		    Integration.Begin()
	...
	#tag Property, Flags = &h21
		Private mIntegrations() As ArkSA.DiscoverIntegration
	#tag EndProperty
...
#tag Events FTPView
	...
	#tag Event
		Function CreateServerProfile(Name As String) As Beacon.ServerProfile
		  Return New ArkSA.ServerProfile(FTP.Identifier, Name)
		End Function
	#tag EndEvent
	#tag Event
	...
	#tag Event
		Function Discover(Provider As FTP.HostingProvider, InitialProfile As Beacon.ServerProfile, SenderThread As Beacon.Thread) As Beacon.ServerProfile()
		  ...
		  For Each Path As String In PotentialPaths
		    ...
		    Var GameIniPath As String = ConfigPath + "/" + ArkSA.ConfigFileGame
		    Var GameUserSettingsIniPath As String = ConfigPath + "/" + ArkSA.ConfigFileGameUserSettings
		    Var ProfileId As String = Beacon.UUID.v5(FTP.Identifier + ":" + InitialProfile.HostConfig.Hash + ":" + GameIniPath)
		    Var Profile As New ArkSA.ServerProfile(FTP.Identifier, ProfileId, InitialProfile.Name, InitialProfile.Nickname, InitialProfile.SecondaryName)
		  ...
		  If Profiles.Count = 0 Then
		    Var GameIniPath As String = Me.ChoosePath(ArkSA.ConfigFileGame, FTPDiscoveryView.ChooserOptionAllowFiles Or FTPDiscoveryView.ChooserOptionStrictNames)
		    ...
		    Else
		      GameUserSettingsIniPath = Me.ChoosePath(ArkSA.ConfigFileGameUserSettings, FTPDiscoveryView.ChooserOptionAllowFiles Or FTPDiscoveryView.ChooserOptionStrictNames)

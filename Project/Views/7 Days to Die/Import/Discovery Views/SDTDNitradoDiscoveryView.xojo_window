#tag DesktopWindow
Begin SDTDDiscoveryView SDTDNitradoDiscoveryView
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub Engine_Discovered(Sender As SDTD.NitradoIntegrationEngine, Data() As Beacon.DiscoveredData)
		  ...
		  If Self.Busy = False And Self.List.RowCount = 0 Then
		    Self.ShowAlert("No eligible servers were found", "Beacon could not find any 7 Days to Die servers on any of the connected Nitrado accounts.")
		    Self.ShouldCancel()
		    Return
		  End If
	...
	#tag Method, Flags = &h21
		Private Function Engine_Wait(Sender As SDTD.NitradoIntegrationEngine, Controller As Beacon.TaskWaitController) As Boolean
	...
	#tag Method, Flags = &h21
		Private Sub ListServers(Token As BeaconAPI.ProviderToken)
		  ...
		  Var Engine As New SDTD.NitradoIntegrationEngine(Profile)

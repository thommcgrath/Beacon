#tag DesktopWindow
Begin BeaconContainer PalworldCommonServerSettingsView
   ...
   Begin UITweaks.ResizedTextField ServerNicknameField
      ...
      Width           =   412
   End
   Begin DesktopTextArea DescriptionField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub Profile(Assigns Profile As Palworld.ServerProfile)
		  Var Items(0) As Palworld.ServerProfile
		  Items(0) = Profile
		  Self.Profiles = Items
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function Profiles() As Palworld.ServerProfile()
		  Return Self.mProfiles
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub Profiles(Assigns Items() As Palworld.ServerProfile)
		  Self.mProfiles = Items
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Function Project() As Palworld.Project
	...
	#tag Property, Flags = &h21
		Private mProfiles() As Palworld.ServerProfile
	#tag EndProperty
...
#tag Events ConfigSetChooseButton
	#tag Event
		Sub Pressed()
		  Var MainProfile As Palworld.ServerProfile = Self.Profile

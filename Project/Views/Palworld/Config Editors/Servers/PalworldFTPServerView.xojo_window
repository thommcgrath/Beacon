#tag DesktopWindow
Begin PalworldServerViewContainer PalworldFTPServerView
   ...
   Begin DesktopPagePanel Pages
      ...
      Begin DesktopGroupBox PathsGroup
         ...
         Begin UITweaks.ResizedLabel SettingsIniPathLabel
            ...
            TabPanelIndex   =   2
            TabStop         =   True
            Text            =   "PalWorldSettings.ini Path:"
            TextAlignment   =   3
            TextColor       =   &c00000000
            Tooltip         =   ""
            Top             =   419
...
#tag WindowCode
	#tag Event
		Sub Shown(UserData As Variant = Nil)
		  ...
		  BeaconUI.SizeToFit(Self.SettingsIniPathLabel, Self.LogsPathLabel)
		  Var FieldsLeft As Integer = Self.SettingsIniPathLabel.Right + 12
		  Var FieldsWidth As Integer = Self.PathsGroup.Right - (20 + FieldsLeft)
		  Var Fields() As DesktopUIControl = Array(Self.SettingsIniPathField, Self.LogsPathField)
		  ...
		  Self.SettingsIniPathField.Text = Self.Profile.SettingsIniPath
...
#tag Events ConnectionView
	...
	#tag EndEvent
#tag EndEvents
#tag Events SettingsIniPathField
	#tag Event
		Sub TextChanged()
		  Self.Profile.SettingsIniPath = Me.Text
		  Self.Modified = Self.Profile.Modified
		End Sub
	#tag EndEvent
#tag EndEvents

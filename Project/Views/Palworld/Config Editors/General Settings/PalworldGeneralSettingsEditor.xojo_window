#tag DesktopWindow
Begin PalworldConfigEditor PalworldGeneralSettingsEditor
   ...
   Begin OmniBar ConfigToolbar
      ...
      Width           =   484
   End
   Begin PalworldSettingsListContainer List
      AllowAutoDeactivate=   True
      AllowFocus      =   False
      AllowFocusRing  =   False
      AllowTabs       =   True
...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As Palworld.Configs.OtherSettings
		  Return Palworld.Configs.OtherSettings(Super.Config(ForWriting))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub SettingChanged(Key As Palworld.ConfigOption, NewValue As Variant)
		  Var Config As Palworld.Configs.OtherSettings = Self.Config(True)
	...
	#tag DelegateDeclaration, Flags = &h0
		Delegate Sub SettingChangeDelegate(Key As Palworld.ConfigOption, Value As Variant)
...
#tag Events List
	...
	#tag EndEvent
	#tag Event
		Function GetConfig(ForWriting As Boolean) As Palworld.Configs.OtherSettings

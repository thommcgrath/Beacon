#tag Window
Begin ConfigEditor DayCycleConfigEditor
   ...
   Visible         =   True
   Width           =   714
   Begin UITweaks.ResizedTextField DayMultiplierField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      ...
      Width           =   80
   End
   Begin UITweaks.ResizedTextField NightMultiplierField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin UITweaks.ResizedLabel NightEqualsLabel
      ...
      Width           =   16
   End
   Begin UITweaks.ResizedTextField DayLengthField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin UITweaks.ResizedTextField NightLengthField
      ...
      Width           =   80
   End
   Begin UITweaks.ResizedLabel DayMinutesLabel
      AllowAutoDeactivate=   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
      ...
      Width           =   83
   End
   Begin UITweaks.ResizedLabel NightMinutesLabel
      AllowAutoDeactivate=   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
      ...
      Width           =   83
   End
   Begin UITweaks.ResizedLabel FullMinutesLabel
      AllowAutoDeactivate=   True
      Bold            =   False
      DataField       =   ""
      DataSource      =   ""
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub UpdateCalculations(Force As Boolean = False)
		  Dim Config As BeaconConfigs.DayCycle = Self.Config(False)
		  Dim DayLengthMinutes As Double = (Self.mOfficialDaySeconds / Config.DaySpeedMultiplier) / 60
		  Dim NightLengthMinutes As Double = (Self.mOfficialNightSeconds / Config.NightSpeedMultiplier) / 60
		  Dim FullLengthMinutes As Double = DayLengthMinutes + NightLengthMinutes
		  ...
		  If Focus <> Self.DayLengthField Then
		    Self.DayLengthField.Value = DayLengthMinutes.PrettyText(2)
		  End If
		  If Focus <> Self.NightLengthField Then
		    Self.NightLengthField.Value = NightLengthMinutes.PrettyText(2)
		  End If
		  Self.FullLengthField.Value = FullLengthMinutes.PrettyText(2)
		End Sub
	#tag EndMethod
	...
	#tag Property, Flags = &h21
		Private mOfficialDaySeconds As Integer
	#tag EndProperty

	#tag Property, Flags = &h21
		Private mOfficialNightSeconds As Integer
	#tag EndProperty
...
#tag Events DayLengthField
	#tag Event
		Sub TextChanged()
		  ...
		  Self.SettingUp = True
		  Dim DesiredLength As Double = Max(CDbl(Me.Value), 0.016666667) // At least one second
		  Self.Config(True).DaySpeedMultiplier = Self.mOfficialDaySeconds / (DesiredLength * 60)
		  Self.Changed = True
		  Self.UpdateCalculations()
		  Self.SettingUp = False
		End Sub
...
#tag Events NightLengthField
	#tag Event
		Sub TextChanged()
		  ...
		  Self.SettingUp = True
		  Dim DesiredLength As Double = Max(CDbl(Me.Value), 0.016666667) // At least one second
		  Self.Config(True).NightSpeedMultiplier = Self.mOfficialNightSeconds / (DesiredLength * 60)
		  Self.Changed = True
		  Self.UpdateCalculations()
		  Self.SettingUp = False
		End Sub

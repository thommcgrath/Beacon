...
#tag Events OmniBar1
	...
	#tag Event
		Sub ItemPressed(Item As OmniBarItem)
		  MessageBox("Activate " + Item.Name)
		End Sub
	#tag EndEvent
	#tag Event
		Sub ShouldCloseItem(Item As OmniBarItem)
		  MessageBox("Close " + Item.Name)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events CheckBox1
	#tag Event
		Sub Action()
		  Self.OmniBar1.Item("NewDocument1").Enabled = Me.Value
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events CheckBox2
	#tag Event
		Sub Action()
		  Self.OmniBar1.Item("NewDocument1").HasUnsavedChanges = Me.Value
		End Sub
	#tag EndEvent
#tag EndEvents
#tag ViewBehavior

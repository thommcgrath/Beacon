#tag Window
Begin Window CustomLootSourceSheet
   BackColor       =   &cFFFFFF00
   Backdrop        =   0
   CloseButton     =   False
   Compatibility   =   ""
...
#tag WindowCode
	#tag Method, Flags = &h0
		Shared Function Present(Parent As Window) As Beacon.LootSource
		  Dim Win As New CustomLootSourceSheet
		  Win.ShowModalWithin(Parent.TrueWindow)
		  Dim LootSource As Beacon.LootSource = Win.mLootSource
		  Win.Close
		  Return LootSource
		End Function
	#tag EndMethod
...
#tag Events ActionButton
	#tag Event
		Sub Action()
		  ...
		  Dim Label As Text = Beacon.Data.NameOfLootSource(Type)

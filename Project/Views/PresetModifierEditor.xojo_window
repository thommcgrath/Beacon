...
Begin BeaconDialog PresetModifierEditor
   ...
   Begin UITweaks.ResizedLabel BlueprintLabel
      ...
      Transparent     =   False
      Underline       =   False
      Value           =   "Blueprint Chance Multiplier:"
      Visible         =   True
      Width           =   180
   End
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As Window, Preset As Beacon.MutablePreset, EditModifierID As String = "") As Boolean
		  ...
		  Dim Win As New PresetModifierEditor(Preset, EditModifierID)
...
#tag Events GroupMenu
	...
	#tag Event
		Sub Change()
		  ...
		  Dim Modifier As Beacon.PresetModifier = Me.RowTag(Me.SelectedRowIndex)
...
#tag Events ActionButton
	#tag Event
		Sub Action()
		  ...
		  Dim Modifier As Beacon.PresetModifier = Self.GroupMenu.RowTag(Self.GroupMenu.SelectedRowIndex)
		  If Modifier = Nil Then

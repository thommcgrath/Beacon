#tag Window
Begin DiscoveryView GSADiscoveryView
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub AdvanceListQueue()
		  ...
		  Var Engine As Beacon.GSAIntegrationEngine = Self.mPendingEngines(0)
	...
	#tag Method, Flags = &h21
		Private Sub Engine_Discovered(Sender As Beacon.GSAIntegrationEngine, Data() As Beacon.DiscoveredData)
		  Self.mActiveEngine = Nil
	...
	#tag Method, Flags = &h21
		Private Sub ListTemplatesForAccount(Account As Beacon.ExternalAccount)
		  Self.mPendingEngines.Add(New Beacon.GSAIntegrationEngine(Account))
	...
	#tag Property, Flags = &h21
		Private mActiveEngine As Beacon.GSAIntegrationEngine
	#tag EndProperty

	#tag Property, Flags = &h21
		Private mPendingEngines() As Beacon.GSAIntegrationEngine
	#tag EndProperty
	...
	#tag Event
		Sub Action()
		  ...
		  For Idx As Integer = 0 To Self.TemplatesList.LastRowIndex
		    ...
		    Var Template As Beacon.GSADiscoveredData = Self.TemplatesList.RowTagAt(Idx)
		    Data.Add(Template)
		  Next

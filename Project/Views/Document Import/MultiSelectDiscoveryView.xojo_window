...
#tag WindowCode
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  Return Self.mAddressColumnLabel
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  If Self.mAddressColumnLabel = Value Then
			    Return
			  End If
			  
			  Self.mAddressColumnLabel = Value
			  If (Self.List Is Nil) = False THen
			    Self.List.HeaderAt(2) = Value
			  End If
			End Set
		#tag EndSetter
		AddressColumnLabel As String
	#tag EndComputedProperty

	#tag Property, Flags = &h21
		Private mAddressColumnLabel As String
	#tag EndProperty
...
#tag Events List
	#tag Event
		Sub Opening()
		  ...
		  Me.ColumnAttributesAt(3).WidthExpression = "0"
		  Me.HeaderAt(2) = Self.mAddressColumnLabel
		End Sub
	#tag EndEvent
	#tag Event

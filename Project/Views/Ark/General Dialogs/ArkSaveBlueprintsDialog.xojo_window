#tag DesktopWindow
Begin BeaconDialog ArkSaveBlueprintsDialog
   Backdrop        =   0
...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Shared Sub Present(Parent As DesktopWindow, Project As Ark.Project)
		  If (Parent Is Nil) = False Then
		    Parent = Parent.TrueWindow
		  End If
		  
		  Var Win As New ArkSaveBlueprintsDialog(Project)
		...
		Sub Pressed()
		  ...
		  For Each Pack As Beacon.ContentPack In Packs
		    ...
		    Case DesktopCheckBox.VisualStates.Checked
		      ...
		      Var Temp() As Ark.Blueprint = Self.mProject.EmbeddedBlueprints(Pack)
		      For Each Blueprint As Ark.Blueprint In Temp
	...
	#tag Event
		Sub CellAction(row As Integer, column As Integer)
		  ...
		  Case IsA Ark.Blueprint
		    ...
		    For Idx As Integer = 0 To Me.LastRowIndex
		      If (Me.RowTagAt(Idx).ObjectValue IsA Ark.Blueprint) = False Or Ark.Blueprint(Me.RowTagAt(Idx)).ContentPackId <> ContentPackId Then
		        Continue
		      End If

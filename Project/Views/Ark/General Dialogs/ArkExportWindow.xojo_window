...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Shared Sub Present(Parent As Window, Project As Ark.Project)
		  ...
		  ElseIf Maps.Count > 1 Then
		    Win.MapMenu.AddRow("All Maps", Ark.Maps.UniversalMask)
	...
	#tag Method, Flags = &h21
		Private Sub Setup()
		  ...
		  If Self.ProfileMenu.SelectedRowIndex > -1 Then
		    Profile = Ark.ServerProfile(Self.ProfileMenu.RowTagAt(Self.ProfileMenu.SelectedRowIndex)).Clone // We need to work on a copy
		  ...
		  Self.SharedRewriter.Source = Ark.Rewriter.Sources.Original
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  ...
			  Select Case Self.Switcher.SelectedIndex
			  Case 1
			    Return Ark.HeaderServerSettings
			  Case 2
			    Return Ark.HeaderShooterGame
			  End Select
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  ...
			  Else
			    Mask = Ark.ServerProfile(Self.ProfileMenu.RowTagAt(Self.ProfileMenu.SelectedRowIndex)).Mask
			  End If
			  Return Mask
			End Get
		#tag EndGetter
	...
	#tag ComputedProperty, Flags = &h21
		#tag Getter
			Get
			  ...
			  Select Case Self.Switcher.SelectedIndex
			  Case 1
			    Return Ark.Rewriter.ModeGameUserSettingsIni
			  Case 2
			    Return Ark.Rewriter.ModeGameIni
			  End Select
			End Get
		#tag EndGetter
	...
	#tag Property, Flags = &h21
		Private mCurrentProfile As Ark.ServerProfile
	#tag EndProperty
	...
	#tag Event
		Sub Finished()
		  ...
		  Else
		    ...
		    If (Me.OutputFlags And Ark.Rewriter.FlagCreateGameIni) = Ark.Rewriter.FlagCreateGameIni Then
		    ...
		    If (Me.OutputFlags And Ark.Rewriter.FlagCreateGameUserSettingsIni) = Ark.Rewriter.FlagCreateGameUserSettingsIni Then
		      If SpecialFinish Then
		    ...
		    If (Me.OutputFlags And Ark.Rewriter.FlagCreateCommandLine) = Ark.Rewriter.FlagCreateCommandLine Then

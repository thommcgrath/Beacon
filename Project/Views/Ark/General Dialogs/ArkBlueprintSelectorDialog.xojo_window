...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, Subgroup As String, Exclude() As Ark.Creature, ContentPacks As Beacon.StringList, SelectMode As ArkBlueprintSelectorDialog.SelectModes, ByRef WithDefaults As Boolean) As Ark.Creature()
		  ...
		  Var Blueprints() As Ark.Blueprint = Present(Parent, Ark.CategoryCreatures, Subgroup, ExcludeBlueprints, ContentPacks, SelectMode, WithDefaults)
	...
	#tag Method, Flags = &h0
		Shared Function Present(Parent As DesktopWindow, Subgroup As String, Exclude() As Ark.Engram, ContentPacks As Beacon.StringList, SelectMode As ArkBlueprintSelectorDialog.SelectModes, ByRef WithDefaults As Boolean) As Ark.Engram()
		  ...
		  Var Blueprints() As Ark.Blueprint = Present(Parent, Ark.CategoryEngrams, Subgroup, ExcludeBlueprints, ContentPacks, SelectMode, WithDefaults)
	...
	#tag Property, Flags = &h21
		Private mSelectMode As ArkBlueprintSelectorDialog.SelectModes
	#tag EndProperty
	...
	#tag Event
		Sub Pressed()
		  ...
		  For Idx As Integer = 0 To Self.SelectedList.LastRowIndex
		    Var Blueprint As Ark.Blueprint = Self.SelectedList.RowTagAt(Idx)
		  ...
		  Preferences.ArkRecentBlueprints(Self.mCategory, Self.mSubgroup) = SelectedPaths
		  Self.mCancelled = False
		  Self.Hide()
		End Sub
	#tag EndEvent

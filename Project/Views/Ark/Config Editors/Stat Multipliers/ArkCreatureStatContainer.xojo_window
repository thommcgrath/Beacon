...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Sub UpdateFigures(Key As String, Config As Ark.Configs.StatMultipliers, Creature As Ark.Creature, OnlyStatIndex As Integer, IncludeFocusControl As Boolean, ForceAsPercentage As Boolean, MultiplyByBase As Boolean)

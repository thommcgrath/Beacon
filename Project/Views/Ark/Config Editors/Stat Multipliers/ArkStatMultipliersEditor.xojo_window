...
Begin ArkConfigEditor ArkStatMultipliersEditor
   ...
   Begin PagePanel PagePanel1
      ...
      Begin UITweaks.ResizedLabel CreatureStatLabel
         ...
         Width           =   78
      End
      Begin ArkCreatureStatContainer WildCreatureStats
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
         ...
         Width           =   251
      End
      Begin ArkCreatureStatContainer TamedCreatureStats
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
         ...
         Width           =   251
      End
      Begin ArkCreatureStatContainer TamedAddCreatureStats
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
         ...
         Width           =   251
      End
      Begin ArkCreatureStatContainer TamedAffinityCreatureStats
         AllowAutoDeactivate=   True
         AllowFocus      =   False
         AllowFocusRing  =   False
         AllowTabs       =   True
...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As Ark.Configs.StatMultipliers
		  Return Ark.Configs.StatMultipliers(Super.Config(ForWriting))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub UpdateCreatureMenu()
		  ...
		  Var Creatures() As Ark.Blueprint = Ark.DataSource.SharedInstance.SearchForBlueprints(Ark.CategoryCreatures, "", Self.Project.ContentPacks, "")
	...
	#tag Method, Flags = &h21
		Private Sub UpdateCreatureStats(OnlyStatIndex As Integer = -1)
		  ...
		  Var Creature As Ark.Creature = Self.CreatureMenu.RowTagAt(Self.CreatureMenu.SelectedRowIndex)
		  Var Config As Ark.Configs.StatMultipliers = Self.Config(False)
		  ...
		  Self.TamedAddCreatureStats.UpdateFigures(Ark.Creature.KeyAdd, Config, Creature, OnlyStatIndex, Self.SettingUp, False, False)
		  Self.TamedAffinityCreatureStats.UpdateFigures(Ark.Creature.KeyAffinity, Config, Creature, OnlyStatIndex, Self.SettingUp, True, False)
		End Sub
	#tag EndMethod

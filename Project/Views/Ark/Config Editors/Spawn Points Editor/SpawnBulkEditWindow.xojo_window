...
#tag Events ChooseCreaturesButton
	#tag Event
		Sub Action()
		  ...
		  Var AddedCreatures() As Beacon.Creature = ArkBlueprintSelectorDialog.Present(Self, "", SelectedCreatures, Self.mMods, ArkBlueprintSelectorDialog.SelectModes.ExplicitMultiple)

#tag Window
Begin ArkConfigEditor SpawnPointsConfigEditor
...
#tag Events List
	...
	#tag Event
		Sub PerformCopy(Board As Clipboard)
		  ...
		  If Not BeaconConfigs.ConfigPurchased(BeaconConfigs.NameSpawnPoints, App.IdentityManager.CurrentIdentity.OmniFlags) Then
		    Return
		  End If

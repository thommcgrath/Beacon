...
#tag Events TargetCreatureButton
	#tag Event
		Sub Action()
		  Var Creatures() As Beacon.Creature = ArkBlueprintSelectorDialog.Present(Self, "", Self.mDefinedCreatures, Self.mMods, ArkBlueprintSelectorDialog.SelectModes.Single)
...
#tag Events ReplacementAddButton
	#tag Event
		Sub Action()
		  ...
		  Var Creatures() As Beacon.Creature = ArkBlueprintSelectorDialog.Present(Self, "", Exclude, Self.mMods, ArkBlueprintSelectorDialog.SelectModes.ExplicitMultiple)

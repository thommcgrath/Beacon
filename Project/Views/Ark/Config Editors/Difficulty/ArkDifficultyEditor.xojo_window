...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As Ark.Configs.Difficulty
		  Return Ark.Configs.Difficulty(Super.Config(ForWriting))
		End Function
	#tag EndMethod

	#tag Method, Flags = &h21
		Private Sub FillReferenceFields(Difficulty As Ark.Configs.Difficulty)
...
#tag Events MaxDinoLevelField
	#tag Event
		Sub TextChange()
		  ...
		  Var Config As Ark.Configs.Difficulty = Self.Config(False)

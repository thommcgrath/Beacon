...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub ConvertGlobalHarvestRate()
		  ...
		  Engrams = Ark.DataSource.Pool.Get(False).GetEngrams("", Self.Project.ContentPacks, New Beacon.TagSpec(Array("harvestable"), Nil))
		  For Each Engram As Ark.Engram In Engrams
	...
	#tag Method, Flags = &h21
		Private Sub UpdateStatus()
		  Self.Status.CenterCaption = Self.List.StatusMessage("Harvest Rate Override", "Harvest Rate Overrides")
		End Sub
	#tag EndMethod

...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As Ark.Configs.ExperienceCurves
		  Return Ark.Configs.ExperienceCurves(Super.Config(ForWriting))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub ShowAddExperience()
		  ...
		  Var Config As Ark.Configs.ExperienceCurves = Self.Config(False)
		  ...
		  If ArkExperienceLevelEditor.Present(Self, Level, LevelXP, MinXP, Ark.Configs.ExperienceCurves.MaxSupportedXP) Then
	...
	#tag Method, Flags = &h21
		Private Sub ShowEditExperience()
		  ...
		  If Self.ViewingPlayerStats Then
		    ...
		    MaxXP = If(Index < CapIndex, Config.PlayerExperience(Index + 1), CType(Ark.Configs.ExperienceCurves.MaxSupportedXP, UInt64))
		  Else
		    ...
		    MaxXP = If(Index < CapIndex, Config.DinoExperience(Index + 1), CType(Ark.Configs.ExperienceCurves.MaxSupportedXP, UInt64))
		  End If

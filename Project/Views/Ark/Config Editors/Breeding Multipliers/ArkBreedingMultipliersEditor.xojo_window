...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As Ark.Configs.BreedingMultipliers
		  Return Ark.Configs.BreedingMultipliers(Super.Config(ForWriting))
		End Function
	#tag EndMethod
	...
	#tag Event
		Sub ItemPressed(Item As OmniBarItem, ItemRect As Rect)
		  ...
		  Case "ShareLinkButton"
		    ...
		    Var Url As String = Beacon.WebURL("/Games/Ark/Breeding")

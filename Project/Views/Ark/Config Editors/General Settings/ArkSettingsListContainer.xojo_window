...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Function CreateElement(Key As Ark.ConfigKey, Left As Integer, Top As Integer, Width As Integer, Height As Integer) As ArkSettingsListElement
		  ...
		  Var Config As Ark.Configs.OtherSettings = Self.Config(False)
	...
	#tag Hook, Flags = &h0
		Event GetConfig(ForWriting As Boolean) As Ark.Configs.OtherSettings
	#tag EndHook
	...
	#tag Property, Flags = &h21
		Private mElements() As ArkSettingsListElement
	#tag EndProperty
	...
	#tag Property, Flags = &h0
		SettingChangeDelegate As ArkGeneralSettingsEditor.SettingChangeDelegate
	#tag EndProperty

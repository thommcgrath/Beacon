...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Function Config(ForWriting As Boolean) As Ark.Configs.DayCycle
		  Return Ark.Configs.DayCycle(Super.Config(ForWriting))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h21
		Private Sub UpdateCalculations(Force As Boolean = False)
		  Var Config As Ark.Configs.DayCycle = Self.Config(False)

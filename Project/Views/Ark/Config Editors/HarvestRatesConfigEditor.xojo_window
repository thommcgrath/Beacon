#tag Window
Begin ArkConfigEditor HarvestRatesConfigEditor
...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub ShowAddOverride()
		  ...
		  Var NewEngrams() As Beacon.Engram = ArkBlueprintSelectorDialog.Present(Self, "Harvesting", CurrentEngrams, Self.Document.Mods, ArkBlueprintSelectorDialog.SelectModes.ImpliedMultiple)
	...
	#tag Method, Flags = &h21
		Private Sub ShowDuplicateOverride()
		  ...
		  Var NewEngrams() As Beacon.Engram = ArkBlueprintSelectorDialog.Present(Self, "Harvesting", CurrentEngrams, Self.Document.Mods, ArkBlueprintSelectorDialog.SelectModes.ExplicitMultiple)
		  If NewEngrams = Nil Or NewEngrams.LastIndex = -1 Then
		    Return
		  End If

...
#tag WindowCode
	...
	#tag Method, Flags = &h21
		Private Sub UpdateStatus()
		  Self.StatusBar1.CenterCaption = Self.EntryList.StatusMessage("Item Set Entry", "Item Set Entries")
		End Sub
	#tag EndMethod
		  ...
		  If Contents.IsNull = False Then
		    Try
		      ...
		      For Each Dict As Dictionary In Dicts
		        Var Entry As Ark.LootItemSetEntry = Ark.LootItemSetEntry.FromSaveData(Dict, Ark.LootItemSetEntry.OptionNewId)
		        If (Entry Is Nil) = False Then

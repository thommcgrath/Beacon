...
#tag WindowCode
	...
	#tag Method, Flags = &h0
		Function Overrides() As Ark.MutableLootDropOverride()
		  Var Results() As Ark.MutableLootDropOverride
		  For Idx As Integer = 0 To Self.mOverrideRefs.LastIndex
		    If (Self.mOverrideRefs(Idx).Value Is Nil) = False Then
		      Results.Add(Ark.MutableLootDropOverride(Self.mOverrideRefs(Idx).Value))
		    End If
		  Next
		  Return Results
		End Function
	...
	#tag Method, Flags = &h0
		Sub Overrides(Assigns Overrides() As Ark.MutableLootDropOverride)
...
#tag Events MinItemSetsField
	#tag Event
		Sub ValueChanged()
		  ...
		  Var Overrides() As Ark.MutableLootDropOverride = Self.Overrides
		  For Idx As Integer = 0 To Overrides.LastIndex

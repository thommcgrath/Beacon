...
Begin BeaconDialog ArkAIGeneratorDialog
   ...
   Begin DesktopLabel ExplanationLabel
      ...
      TabPanelIndex   =   0
      TabStop         =   True
      Text            =   "Thanks to machine learning and thousands of Beacon projects saved to the cloud, Beacon can figure out what you want with just a few words."
      TextAlignment   =   0
      TextColor       =   &c00000000
      Tooltip         =   ""
      Top             =   52
   ...
   Begin UITweaks.ResizedTextField PhraseField
      ...
      HasBorder       =   True
      Height          =   22
      Hint            =   "What changes would you like?"
      Index           =   -2147483648
      Italic          =   False
      Left            =   20
      LockBottom      =   False

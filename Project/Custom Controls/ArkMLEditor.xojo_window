...
Begin ContainerControl ArkMLEditor
   ...
   Begin FadedSeparator RightBorder
      ...
      Width           =   1
   End
   Begin FadedSeparator ToolbarBorder
      AllowAutoDeactivate=   True
      AllowFocus      =   False
      AllowFocusRing  =   True
      AllowTabs       =   False
...
#tag WindowCode
	...
	#tag Method, Flags = &h1
		Protected Sub ChangeSelectionColor()
		  ...
		  If Not Color.SelectedFromDialog(UserColor, "Select Text Color") Then
		    Return
		  End If
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  Return Self.mRawMode
			End Get
		#tag EndGetter
		#tag Setter
			Set
			  If Self.mRawMode = Value Then
			    Return
			  End If
...
#tag Events Field
	...
	#tag Event
		Function ConstructContextualMenu(base as MenuItem, x as Integer, y as Integer) As Boolean
		  ...
		  ClearItem.Enabled = HasSelection
		  ColorItem.Enabled = HasSelection
		  
		  Var Board As New Clipboard
		  Var CanPaste As Boolean = Board.TextAvailable

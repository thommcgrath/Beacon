...
Protected Class ConfigValue
	#tag Method, Flags = &h0
		Sub Constructor(Key As Palworld.ConfigOption, Command As String, Index As Integer = 0)
	...
	#tag Method, Flags = &h0
		Sub Constructor(Key As Palworld.ConfigOption, Command As String, SortKey As String)
		  Self.ParseCommand(Command)
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			...
			End Get
		#tag EndGetter
		Details As Palworld.ConfigOption
	#tag EndComputedProperty
	...
	#tag Property, Flags = &h21
		Private mKeyDetails As Palworld.ConfigOption
	#tag EndProperty

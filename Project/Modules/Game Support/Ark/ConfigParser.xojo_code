...
Private Class ConfigParser
	#tag Method, Flags = &h0
		Function AddCharacter(Char As String) As Boolean
		  Static LineEndingChar As String = Ark.ImportThread.LineEndingChar
		  ...
		  Case Self.TypeIntrinsic
		    ...
		    Case "("
		      If Self.Buffer.LastIndex = -1 Then
		        Self.SubParser = New Ark.ConfigParser(Self.Level + 1)
		    ...
		    Case "="
		      If Not Self.KeyFound Then
		        ...
		        Self.SubParser = New Ark.ConfigParser(Self.Level) // Same level
	...
	#tag Property, Flags = &h21
		Private SubParser As Ark.ConfigParser
	#tag EndProperty

...
Protected Class SpawnPointLevel
	#tag Method, Flags = &h0
		Sub Constructor(Source As Ark.SpawnPointLevel)
	...
	#tag Method, Flags = &h0
		Shared Function FromSaveData(Dict As Dictionary) As Ark.SpawnPointLevel
		  If Dict Is Nil Then
		    Return Nil
		  End If
	...
	#tag Method, Flags = &h0
		Shared Function FromUserLevel(MinLevel As Integer, MaxLevel As Integer, Difficulty As Double) As Ark.SpawnPointLevel
		  // See note Formula
		  
		  Var Levels As New Ark.SpawnPointLevel(0, 0, 0)
	...
	#tag Method, Flags = &h0
		Function Operator_Compare(Other As Ark.SpawnPointLevel) As Integer
		  If Other = Nil Then
		    Return 1
		  End If

...
Implements Beacon.NamedItem
	...
	#tag Method, Flags = &h0
		Sub Constructor(Source As Ark.SpawnPointSetEntry)
		  ...
		  If (Source.mCreatureRef Is Nil) = False Then
		    Self.mCreatureRef = New Ark.BlueprintReference(Source.mCreatureRef)
		  End If
	...
	#tag Method, Flags = &h0
		Function Creature() As Ark.Creature
		  Var Blueprint As Ark.Blueprint = Self.mCreatureRef.Resolve()
		  If (Blueprint Is Nil) = False And Blueprint IsA Ark.Creature Then
		    Return Ark.Creature(Blueprint)
		  End If
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function CreatureReference() As Ark.BlueprintReference
	...
	#tag Method, Flags = &h0
		Shared Function FromSaveData(Dict As JSONItem) As Ark.SpawnPointSetEntry
		  ...
		  ElseIf Dict.HasKey("creature") Then
		    Var Reference As Ark.BlueprintReference = Ark.BlueprintReference.FromSaveData(Dict.Child("creature"))

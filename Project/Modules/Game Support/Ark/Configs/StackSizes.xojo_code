...
Inherits Ark.ConfigGroup
	...
	#tag Event
		Function GetManagedKeys() As Ark.ConfigOption()
		  ...
		  Keys.Add(New Ark.ConfigOption(Ark.ConfigFileGameUserSettings, Ark.HeaderServerSettings, "ItemStackSizeMultiplier"))
		  Keys.Add(New Ark.ConfigOption(Ark.ConfigFileGame, Ark.HeaderShooterGame, "ConfigOverrideItemMaxQuantity"))
		  Return Keys
		End Function
	#tag EndEvent

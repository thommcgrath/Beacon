...
Inherits Ark.ConfigGroup
	...
	#tag Method, Flags = &h0
		Shared Function FromImport(ParsedData As Dictionary, CommandLineOptions As Dictionary, MapCompatibility As UInt64, Difficulty As Double, Mods As Beacon.StringList) As Ark.Configs.CraftingCosts
		  ...
		  For Each Dict As Dictionary In Overrides
		    Var Cost As Ark.CraftingCost = Ark.CraftingCost.ImportFromConfig(Dict, Mods)
		    If Cost <> Nil Then
		      Config.Add(Cost)
		    End If
		  Next

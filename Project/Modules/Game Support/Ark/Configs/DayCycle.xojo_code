...
Inherits Ark.ConfigGroup
	...
	#tag Event
		Function GetManagedKeys() As Ark.ConfigOption()
		  ...
		  Keys.Add(New Ark.ConfigOption(Ark.ConfigFileGameUserSettings, Ark.HeaderServerSettings, "DayCycleSpeedScale"))
		  Keys.Add(New Ark.ConfigOption(Ark.ConfigFileGameUserSettings, Ark.HeaderServerSettings, "DayTimeSpeedScale"))
		  Keys.Add(New Ark.ConfigOption(Ark.ConfigFileGameUserSettings, Ark.HeaderServerSettings, "NightTimeSpeedScale"))
		  Return Keys
		End Function
	#tag EndEvent

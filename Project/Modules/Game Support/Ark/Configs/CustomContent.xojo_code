...
Inherits Ark.ConfigGroup
	...
	#tag Event
		Function GenerateConfigValues(Project As Ark.Project, Profile As Ark.ServerProfile) As Ark.ConfigValue()
		  ...
		  Var Organizer As New Ark.ConfigOrganizer(Ark.ConfigFileGameUserSettings, Ark.HeaderServerSettings, Self.CleanupContent(Self.mGameUserSettingsIniContent))
		  Organizer.Add(Ark.ConfigFileGame, Ark.HeaderShooterGame, Self.CleanupContent(Self.mGameIniContent.ReplaceAll(Ark.HeaderShooterGameUWP, Ark.HeaderShooterGame)))

...
Inherits ArkSA.ConfigGroup
	#tag Event
		Sub CopyFrom(Other As ArkSA.ConfigGroup)
		  Var Source As ArkSA.Configs.BreedingMultipliers = ArkSA.Configs.BreedingMultipliers(Other)
	...
	#tag Event
		Function GenerateConfigValues(Project As ArkSA.Project, Profile As ArkSA.ServerProfile) As ArkSA.ConfigValue()
		  ...
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyCuddleGracePeriodMultiplier=" + Self.BabyCuddleGracePeriodMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyCuddleIntervalMultiplier=" + Self.BabyCuddleIntervalMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyCuddleLoseImprintQualitySpeedMultiplier=" + Self.BabyCuddleLoseImprintQualitySpeedMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyFoodConsumptionSpeedMultiplier=" + Self.BabyFoodConsumptionSpeedMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyImprintAmountMultiplier=" + Self.BabyImprintAmountMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyImprintingStatScaleMultiplier=" + Self.BabyImprintingStatScaleMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyMatureSpeedMultiplier=" + Self.BabyMatureSpeedMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "EggHatchSpeedMultiplier=" + Self.EggHatchSpeedMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "LayEggIntervalMultiplier=" + Self.LayEggIntervalMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "MatingIntervalMultiplier=" + Self.MatingIntervalMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "MatingSpeedMultiplier=" + Self.MatingSpeedMultiplier.PrettyText))
		  If (Self.mAllowAnyoneBabyImprintCuddle Is Nil) = False Then
		    Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "AllowAnyoneBabyImprintCuddle=" + If(Self.AllowAnyoneBabyImprintCuddle, "True", "False")))
		  End If
		  If (Self.mDisableImprintDinoBuff Is Nil) = False Then
		    Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "DisableImprintDinoBuff=" + If(Self.DisableImprintDinoBuff, "True", "False")))
		  End If
		  Return Values
		End Function
	#tag EndEvent
	...
	#tag Event
		Function GetManagedKeys() As ArkSA.ConfigOption()
		  ...
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyCuddleGracePeriodMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyCuddleIntervalMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyCuddleLoseImprintQualitySpeedMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyFoodConsumptionSpeedMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyImprintAmountMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyImprintingStatScaleMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "BabyMatureSpeedMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "EggHatchSpeedMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "LayEggIntervalMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "MatingIntervalMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "MatingSpeedMultiplier"))
		  If (Self.mAllowAnyoneBabyImprintCuddle Is Nil) = False Then
		    Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "AllowAnyoneBabyImprintCuddle"))
		  End If
		  If (Self.mDisableImprintDinoBuff Is Nil) = False Then
		    Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "DisableImprintDinoBuff"))
		  End If
		  Return Keys
		End Function
	#tag EndEvent
	...
	#tag Method, Flags = &h0
		Shared Function FromImport(ParsedData As Dictionary, CommandLineOptions As Dictionary, MapCompatibility As UInt64, Difficulty As Double, ContentPacks As Beacon.StringList) As ArkSA.Configs.BreedingMultipliers
		  ...
		  Var Multipliers As New ArkSA.Configs.BreedingMultipliers

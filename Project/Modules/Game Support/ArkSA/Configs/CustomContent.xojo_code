...
Inherits ArkSA.ConfigGroup
	...
	#tag Event
		Function GenerateConfigValues(Project As ArkSA.Project, Profile As ArkSA.ServerProfile) As ArkSA.ConfigValue()
		  ...
		  Var Organizer As New ArkSA.ConfigOrganizer(ArkSA.ConfigFileGameUserSettings, ArkSA.HeaderServerSettings, Self.CleanupContent(Self.mGameUserSettingsIniContent, ArkSA.HeaderServerSettings, Profile))
		  Organizer.Add(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, Self.CleanupContent(Self.mGameIniContent.ReplaceAll(ArkSA.HeaderShooterGameUWP, ArkSA.HeaderShooterGame), ArkSA.HeaderShooterGame, Profile))
	...
	#tag Method, Flags = &h21
		Private Function CleanupContent(Content As String, DefaultHeader As String, Profile As ArkSA.ServerProfile) As String

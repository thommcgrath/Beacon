...
Inherits ArkSA.ConfigGroup
	...
	#tag Event
		Function GenerateConfigValues(Project As ArkSA.Project, Profile As ArkSA.ServerProfile) As ArkSA.ConfigValue()
		  ...
		  Values.Add(New ArkSA.ConfigValue("CommandLineFlag", "-", "AutoDestroyStructures=" + If(Self.mAutoDestroyStructures, "True", "False")))
		  
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "AutoDestroyDecayedDinos=" + If(Self.mAutoDestroyDecayedDinos, "True", "False")))
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "AutoDestroyOldStructuresMultiplier=" + Self.mAutoDestroyOldStructuresMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "ClampItemSpoilingTimes=" + If(Self.mClampItemSpoilingTimes, "True", "False")))
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "FastDecayUnsnappedCoreStructures=" + If(Self.mFastDecayUnsnappedCoreStructures, "True", "False")))
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "OnlyAutoDestroyCoreStructures=" + If(Self.mOnlyAutoDestroyCoreStructures, "True", "False")))
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "OnlyDecayUnsnappedCoreStructures=" + If(Self.mOnlyDecayUnsnappedCoreStructures, "True", "False")))
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "PvEDinoDecayPeriodMultiplier=" + Self.mPvEDinoDecayPeriodMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "PvPDinoDecay=" + If(Self.mPvPDinoDecay, "True", "False")))
		  Values.Add(New ArkSA.ConfigValue("CommandLineOption", "?", "PvPStructureDecay=" + If(Self.mPvPStructureDecay, "True", "False")))
		  
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "bDisableDinoDecayClaiming=" + If(Self.mDisableDinoDecayClaiming, "True", "False")))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "CropDecaySpeedMultiplier=" + Self.mCropDecaySpeedMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "FastDecayInterval=" + Self.mFastDecayInterval.ToString(Locale.Raw, "0")))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "GlobalCorpseDecompositionTimeMultiplier=" + Self.mGlobalCorpseDecompositionTimeMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "GlobalItemDecompositionTimeMultiplier=" + Self.mGlobalItemDecompositionTimeMultiplier.PrettyText))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "GlobalSpoilingTimeMultiplier=" + Self.mGlobalSpoilingTimeMultiplier.PrettyText))
		  
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGameUserSettings, ArkSA.HeaderServerSettings, "DisableDinoDecayPvE=" + If(Self.mDisableDinoDecayPvE, "True", "False")))
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGameUserSettings, ArkSA.HeaderServerSettings, "DisableStructureDecayPvE=" + If(Self.mDisableStructureDecayPvE, "True", "False")))
		  If Self.mPvEStructureDecayDestructionPeriod <> 0 Then
		    Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGameUserSettings, ArkSA.HeaderServerSettings, "PvEStructureDecayDestructionPeriod=" + Self.mPvEStructureDecayDestructionPeriod.ToString(Locale.Raw, "0")))
		  End If
		  Values.Add(New ArkSA.ConfigValue(ArkSA.ConfigFileGameUserSettings, ArkSA.HeaderServerSettings, "PvEStructureDecayPeriodMultiplier=" + Self.mPvEStructureDecayPeriodMultiplier.PrettyText))
	...
	#tag Event
		Function GetManagedKeys() As ArkSA.ConfigOption()
		  ...
		  Keys.Add(New ArkSA.ConfigOption("CommandLineFlag", "-", "AutoDestroyStructures"))
		  
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "AutoDestroyDecayedDinos"))
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "AutoDestroyOldStructuresMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "ClampItemSpoilingTimes"))
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "FastDecayUnsnappedCoreStructures"))
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "OnlyAutoDestroyCoreStructures"))
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "OnlyDecayUnsnappedCoreStructures"))
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "PvEDinoDecayPeriodMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "PvPDinoDecay"))
		  Keys.Add(New ArkSA.ConfigOption("CommandLineOption", "?", "PvPStructureDecay"))
		  
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "bDisableDinoDecayClaiming"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "CropDecaySpeedMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "FastDecayInterval"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "GlobalCorpseDecompositionTimeMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "GlobalItemDecompositionTimeMultiplier"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGame, ArkSA.HeaderShooterGame, "GlobalSpoilingTimeMultiplier"))
		  
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGameUserSettings, ArkSA.HeaderServerSettings, "DisableDinoDecayPvE"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGameUserSettings, ArkSA.HeaderServerSettings, "DisableStructureDecayPvE"))
		  Keys.Add(New ArkSA.ConfigOption(ArkSA.ConfigFileGameUserSettings, ArkSA.HeaderServerSettings, "PvEStructureDecayDestructionPeriod"))
	...
	#tag Method, Flags = &h0
		Shared Function FromImport(ParsedData As Dictionary, CommandLineOptions As Dictionary, MapCompatibility As UInt64, Difficulty As Double, ContentPacks As Beacon.StringList) As ArkSA.Configs.SpoilTimers
		  #Pragma Unused MapCompatibility
		  #Pragma Unused Difficulty
		  #Pragma Unused ContentPacks
		  
		  Var Spoil As New ArkSA.Configs.SpoilTimers
	...
	#tag Method, Flags = &h0
		Function InternalName() As String
		  Return ArkSA.Configs.NameDecayAndSpoil
		End Function
	#tag EndMethod

...
Implements ArkSA.Blueprint,Beacon.DisambiguationCandidate
	#tag Method, Flags = &h0
		Function AllStatValues() As ArkSA.CreatureStatValue()
		  ...
		  For Each Stat As ArkSA.Stat In Stats
		    Var Value As ArkSA.CreatureStatValue = Self.StatValue(Stat)
	...
	#tag Method, Flags = &h0
		Function Category() As String
		  Return ArkSA.CategoryCreatures
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function Clone() As ArkSA.Creature
	...
	#tag Method, Flags = &h0
		Sub Constructor(Source As ArkSA.Creature)
		  Self.Constructor()
	...
	#tag Method, Flags = &h0
		Shared Function CreateCustom(BlueprintId As String, Path As String, ClassString As String) As ArkSA.Creature
		  Var Creature As New ArkSA.Creature
		  Creature.mContentPackId = ArkSA.UserContentPackId
		  Creature.mContentPackName = ArkSA.UserContentPackName
		  ...
		  If Path.IsEmpty Then
		    ...
		    End If
		    Path = ArkSA.UnknownBlueprintPath("Creatures", ClassString)
		  ...
		  Creature.mLabel = ArkSA.LabelFromClassString(ClassString)
		  Return Creature
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function MutableClone() As ArkSA.MutableCreature
		  // Part of the ArkSA.Blueprint interface.
	...
	#tag Method, Flags = &h0
		Function Operator_Compare(Other As ArkSA.Creature) As Integer
	...
	#tag Method, Flags = &h0
		Function StatAddValue(Stat As ArkSA.Stat) As Double
		  Return Self.StatValue(Stat, Self.KeyAdd)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Function StatAffinityValue(Stat As ArkSA.Stat) As Double
		  Return Self.StatValue(Stat, Self.KeyAffinity)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Function StatBaseValue(Stat As ArkSA.Stat) As Double
	...
	#tag Method, Flags = &h0
		Function StatTamedValue(Stat As ArkSA.Stat) As Double
		  Return Self.StatValue(Stat, Self.KeyTamed)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Function StatValue(Stat As ArkSA.Stat) As ArkSA.CreatureStatValue
		  ...
		  Return New ArkSA.CreatureStatValue(Stat, BaseValue, WildMultiplier, TamedMultiplier, AddMultiplier, AffinityMultiplier)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Function StatValue(Stat As ArkSA.Stat, Key As String) As Double
	...
	#tag Method, Flags = &h0
		Function StatWildValue(Stat As ArkSA.Stat) As Double
	...
	#tag Method, Flags = &h0
		Function UsesStats() As ArkSA.Stat()
		  Return ArkSA.Stats.ForMask(Self.mStatsMask)
		End Function
	#tag EndMethod

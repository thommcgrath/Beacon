...
Implements Beacon.Countable,Iterable
	...
	#tag Method, Flags = &h0
		Sub Constructor(Source As ArkSA.LootTemplate)
		  ...
		  For I As Integer = 0 To Self.mEntries.LastIndex
		    Self.mEntries(I) = New ArkSA.LootTemplateEntry(Source.mEntries(I))
		  Next
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Shared Function FromSaveData(Dict As JSONItem) As Beacon.Template
		  ...
		  Var Template As New ArkSA.LootTemplate
		  ...
		  If (Members Is Nil) = False Then
		    For Idx As Integer = 0 To Members.LastRowIndex
		      Var Entry As ArkSA.LootTemplateEntry = ArkSA.LootTemplateEntry.FromSaveData(Members.ChildAt(Idx))
	...
	#tag Method, Flags = &h0
		Function ImmutableClone() As ArkSA.LootTemplate
	...
	#tag Method, Flags = &h0
		Function IndexOf(Entry As ArkSA.LootTemplateEntry) As Integer
	...
	#tag Method, Flags = &h0
		Function MutableClone() As ArkSA.MutableLootTemplate
		  Return New ArkSA.MutableLootTemplate(Self)
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function Operator_Compare(Other As ArkSA.LootTemplate) As Integer
	...
	#tag Method, Flags = &h0
		Function Operator_Subscript(Idx As Integer) As ArkSA.LootTemplateEntry
	...
	#tag Method, Flags = &h0
		Function RebuildLootItemSet(Destination As ArkSA.MutableLootItemSet, Mask As UInt64, Container As ArkSA.LootContainer, ContentPacks As Beacon.StringList) As Boolean
		  ...
		  For Idx As Integer = 0 To Source.LastIndex
		    Var DestinationEntry As ArkSA.LootItemSetEntry = Destination(Idx)
		    Var SourceEntry As ArkSA.LootItemSetEntry = Source(Idx)
	...
	#tag Method, Flags = &h0
		Function ValidForMap(Map As ArkSA.Map) As Boolean
	...
	#tag Property, Flags = &h1
		Protected mEntries() As ArkSA.LootTemplateEntry
	#tag EndProperty

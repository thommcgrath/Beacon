...
Protected Class ConfigValue
	#tag Method, Flags = &h0
		Sub Constructor(Key As ArkSA.ConfigOption, Command As String, Index As Integer = 0)
	...
	#tag Method, Flags = &h0
		Sub Constructor(Key As ArkSA.ConfigOption, Command As String, SortKey As String)
		  Self.ParseCommand(Command)
	...
	#tag Method, Flags = &h0
		Sub Constructor(File As String, Header As String, Command As String, Index As Integer = 0)
		  ...
		  Var Keys() As ArkSA.ConfigOption = ArkSA.DataSource.Pool.Get(False).GetConfigOptions(File, Header, Self.mSimplifiedKey, False)
		  Var ConfigOption As ArkSA.ConfigOption
		  If Keys.Count >= 1 Then
		    ConfigOption = Keys(0)
		  Else
		    ConfigOption = New ArkSA.ConfigOption(File, Header, Self.mSimplifiedKey)
		  End If
	...
	#tag Property, Flags = &h21
		Private mKeyDetails As ArkSA.ConfigOption
	#tag EndProperty

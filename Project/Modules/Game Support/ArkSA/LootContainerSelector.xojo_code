...
Protected Class LootContainerSelector
	...
	#tag Method, Flags = &h1
		Protected Shared Function CreateEngine(Source As ArkSA.LootContainer) As JavascriptEngineMBS
	...
	#tag Method, Flags = &h0
		Function Matches(Sources() As ArkSA.LootContainer) As ArkSA.LootContainer()
		  Var Results() As ArkSA.LootContainer
		  For Each Source As ArkSA.LootContainer In Sources
	...
	#tag Method, Flags = &h0
		Function Matches(Source As ArkSA.LootContainer) As Boolean

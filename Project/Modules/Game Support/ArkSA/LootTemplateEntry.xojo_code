...
Implements Beacon.Countable,Iterable
	...
	#tag Method, Flags = &h0
		Sub Constructor(Source As ArkSA.LootTemplateEntry)
		  Self.Constructor()
	...
	#tag Method, Flags = &h0
		Function ImmutableClone() As ArkSA.LootTemplateEntry
	...
	#tag Method, Flags = &h0
		Function IndexOf(Option As ArkSA.LootItemSetEntryOption) As Integer
		  For Idx As Integer = 0 To Self.mOptions.LastIndex
	...
	#tag Method, Flags = &h0
		Function MutableClone() As ArkSA.MutableLootTemplateEntry
		  Return New ArkSA.MutableLootTemplateEntry(Self)
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function Operator_Compare(Other As ArkSA.LootTemplateEntry) As Integer
	...
	#tag Method, Flags = &h0
		Function Operator_Convert() As ArkSA.LootItemSetEntry
	...
	#tag Method, Flags = &h0
		Sub Operator_Convert(Source As ArkSA.LootItemSetEntry)
		  Self.Constructor()
		  ...
		  // It's ok to reference the source objects here, they are not mutable
		  For Each Option As ArkSA.LootItemSetEntryOption In Source
	...
	#tag Method, Flags = &h0
		Function Operator_Subscript(Idx As Integer) As ArkSA.LootItemSetEntryOption

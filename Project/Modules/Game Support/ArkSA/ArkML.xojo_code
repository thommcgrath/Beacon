...
Protected Class ArkML
	#tag Method, Flags = &h0
		Function ArkMLValue() As String
		  ...
		  // The first <RichColor> on each line gets replaced with a space. Whatever ArkSA...
	...
	#tag Method, Flags = &h0
		Shared Function FromArkML(Source As String) As ArkSA.ArkML
		  Try
		    Var ML As New ArkSA.ArkML
	...
	#tag Method, Flags = &h0
		Shared Function FromArray(Source() As Dictionary) As ArkSA.ArkML
		  Try
		    Var ML As New ArkSA.ArkML
	...
	#tag Method, Flags = &h0
		Shared Function FromObjects(Source() As Object) As ArkSA.ArkML
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit))
		Shared Function FromRTF(Source As String) As ArkSA.ArkML
		  Try
		    Var ML As New ArkSA.ArkML
		    ML.RTFValue = Source
		    Return ML
	...
	#tag Method, Flags = &h0
		Shared Function FromSaveData(Source As String) As ArkSA.ArkML
		  Try
	...
	#tag Method, Flags = &h0
		Function Operator_Compare(Other As ArkSA.ArkML) As Integer
	...
	#tag Method, Flags = &h0
		Function SaveData() As String
		  ...
		  Next
		  Return EncodeBase64URLMBS(Beacon.Compress(Item.ToString(True)))
		End Function
	#tag EndMethod

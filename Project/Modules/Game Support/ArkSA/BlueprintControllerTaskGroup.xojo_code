...
Inherits ArkSA.BlueprintControllerTask
Implements Beacon.Countable,Iterable
	#tag CompatibilityFlags = ( TargetConsole and ( Target32Bit or Target64Bit ) ) or ( TargetWeb and ( Target32Bit or Target64Bit ) ) or ( TargetDesktop and ( Target32Bit or Target64Bit ) ) or ( TargetIOS and ( Target64Bit ) ) or ( TargetAndroid and ( Target64Bit ) )
	#tag Method, Flags = &h0
		Function Child(Idx As Integer) As ArkSA.BlueprintControllerTask
		  Return Self.mChildren(Idx)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Sub Constructor(Tasks() As ArkSA.BlueprintControllerTask)
	...
	#tag Method, Flags = &h0
		Function FindTask(TaskId As String) As ArkSA.BlueprintControllerTask
		  For Idx As Integer = 0 To Self.mChildren.LastIndex
	...
	#tag Method, Flags = &h0
		Sub FinishTask(Task As ArkSA.BlueprintControllerTask)
	...
	#tag Property, Flags = &h21
		Private mChildren() As ArkSA.BlueprintControllerTask
	#tag EndProperty

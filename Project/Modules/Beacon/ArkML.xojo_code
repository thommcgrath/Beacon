...
Protected Class ArkML
	...
	#tag Method, Flags = &h0
		Function Clone() As Beacon.ArkML
	...
	#tag Method, Flags = &h0
		Shared Function FromArkML(Source As String) As Beacon.ArkML
		  Try
		    Var ML As New Beacon.ArkML
	...
	#tag Method, Flags = &h0
		Shared Function FromArray(Source() As Dictionary) As Beacon.ArkML
		  Try
		    Var ML As New Beacon.ArkML
	...
	#tag Method, Flags = &h0
		Shared Function FromObjects(Source() As Object) As Beacon.ArkML
	...
	#tag Method, Flags = &h0, CompatibilityFlags = (TargetConsole and (Target32Bit or Target64Bit)) or  (TargetWeb and (Target32Bit or Target64Bit)) or  (TargetDesktop and (Target32Bit or Target64Bit))
		Shared Function FromRTF(Source As String) As Beacon.ArkML
		  Try
		    Var ML As New Beacon.ArkML
		    ML.RTFValue = Source
		    Return ML
	...
	#tag Method, Flags = &h0
		Function Operator_Compare(Other As Beacon.ArkML) As Integer

...
Protected Class CraftingCost
	...
	#tag Method, Flags = &h0
		Function Operator_Compare(Other As Beacon.CraftingCost) As Integer
		  ...
		  Dim Result As Integer = StrComp(SelfName, OtherName, 0)
		  If Result = 0 Then
		    Result = StrComp(Self.mObjectID, Other.mObjectID, 0)
		  End If
		  Return Result
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Function StringValue() As String
		  ...
		  For I As Integer = 0 To Self.mResources.Ubound
		    ...
		    Dim QuantityString As String = Str(Self.mQuantities(I), "0")

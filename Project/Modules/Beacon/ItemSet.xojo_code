...
Implements Beacon.Countable,Beacon.DocumentItem
	...
	#tag Method, Flags = &h0
		Function ReconfigureWithPreset(Preset As Beacon.Preset = Nil, ForLootSource As Beacon.LootSource, Document As Beacon.Document) As Boolean
		  Return Self.ReconfigureWithPreset(Preset, ForLootSource, Document.MapCompatibility, Document.ConsoleModsOnly)
		End Function
	#tag EndMethod

	#tag Method, Flags = &h0
		Function ReconfigureWithPreset(Preset As Beacon.Preset = Nil, ForLootSource As Beacon.LootSource, Mask As UInt64, ConsoleSafe As Boolean) As Boolean

...
Protected Module Preferences
	...
	#tag Method, Flags = &h1
		Protected Function IgnoredLicenseIds() As String()
		  ...
		  For Idx As Integer = 0 To Licenses.LastRowIndex
		    LicenseIds.Add(Licenses.ValueAt(Idx).StringValue)
		  Next
		  Return LicenseIds
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h1
		Protected Sub IgnoredLicenseIds(Assigns LicenseIds() As String)
		  Var Licenses As New JSONItem("[]")
		  For Each LicenseId As String In LicenseIds

	...
	#tag Method, Flags = &h1
		Protected Function RewriteIniContent(InitialContent As Text, NewConfigs As Xojo.Core.Dictionary, WithMarkup As Boolean = True) As Text
		  ...
		  For I As Integer = 0 To Lines.Ubound
		    ...
		    If Line = Beacon.MarkupPrefix + BeginBeaconTag Then
		      InBeaconContentGroup = True
		      Continue
		    ElseIf Line = Beacon.MarkupPrefix + EndBeaconTag Then
		  ...
		  If WithMarkup Then
		    NewLines.Append(Beacon.MarkupPrefix + "This file was generated by Beacon " + App.NonReleaseVersion.ToText)
		    NewLines.Append(Beacon.MarkupPrefix + "Sections of this file are marked with comments that helps ensure Beacon")
		    NewLines.Append(Beacon.MarkupPrefix + "updates it correctly in the future. Do not edit content between the")
		    NewLines.Append(Beacon.MarkupPrefix + BeginBeaconTag + " and " + EndBeaconTag + " lines.")
		  End If
		  For Each Header As Text In AllSectionHeaders
		    ...
		    If NewConfigs.HasKey(Header) Then
		      ...
		      If WithMarkup Then
		        NewLines.Append(Beacon.MarkupPrefix + BeginBeaconTag)
		      End If
		      For Each Entry As Xojo.Core.DictionaryEntry In Section
		        Dim Values() As Text = Entry.Value
		        For Each Line As Text In Values
		      ...
		      Next
		      If WithMarkup Then
		        NewLines.Append(Beacon.MarkupPrefix + EndBeaconTag)
		      End If
		    End If
		  Next

...
Implements NotificationKit.Receiver,Beacon.Application
	...
	#tag Event
		Sub Opening()
		  Self.mLogManager = New LogManager
		    ...
		    Try
		      Var MBSData As New JSONItem(Self.MBSLicense)
	...
	#tag Method, Flags = &h21
		Private Function MBSLicense() As String
		  ...
		  Return DefineEncoding(DecodeBase64(Chars.Middle(5, 1) + Chars.Middle(13, 1) + Chars.Middle(48, 1) + Chars.Middle(49, 1) + Chars.Middle(12, 1) + Chars.Middle(43, 1) + Chars.Middle(42, 1) + Chars.Middle(13, 1) + Chars.Middle(24, 1) + Chars.Middle(47, 1) + Chars.Middle(21, 1) + Chars.Middle(26, 1) + Chars.Middle(39, 1) + Chars.Middle(33, 1) + Chars.Middle(52, 1) + Chars.Middle(35, 1) + Chars.Middle(52, 1) + Chars.Middle(6, 1) + Chars.Middle(25, 1) + Chars.Middle(8, 1) + Chars.Middle(39, 1) + Chars.Middle(33, 1) + Chars.Middle(0, 1) + Chars.Middle(34, 1) + Chars.Middle(36, 1) + Chars.Middle(42, 1) + Chars.Middle(8, 1) + Chars.Middle(23, 1) + Chars.Middle(37, 1) + Chars.Middle(22, 1) + Chars.Middle(25, 1) + Chars.Middle(49, 1) + Chars.Middle(39, 1) + Chars.Middle(19, 1) + Chars.Middle(6, 1) + Chars.Middle(4, 1) + Chars.Middle(12, 1) + Chars.Middle(13, 1) + Chars.Middle(52, 1) + Chars.Middle(30, 1) + Chars.Middle(52, 1) + Chars.Middle(50, 1) + Chars.Middle(0, 1) + Chars.Middle(7, 1) + Chars.Middle(20, 1) + Chars.Middle(43, 1) + Chars.Middle(26, 1) + Chars.Middle(7, 1) + Chars.Middle(39, 1) + Chars.Middle(43, 1) + Chars.Middle(37, 1) + Chars.Middle(11, 1) + Chars.Middle(28, 1) + Chars.Middle(11, 1) + Chars.Middle(48, 1) + Chars.Middle(53, 1) + Chars.Middle(36, 1) + Chars.Middle(6, 1) + Chars.Middle(18, 1) + Chars.Middle(23, 1) + Chars.Middle(36, 1) + Chars.Middle(43, 1) + Chars.Middle(17, 1) + Chars.Middle(26, 1) + Chars.Middle(12, 1) + Chars.Middle(19, 1) + Chars.Middle(51, 1) + Chars.Middle(6, 1) + Chars.Middle(14, 1) + Chars.Middle(19, 1) + Chars.Middle(37, 1) + Chars.Middle(11, 1) + Chars.Middle(40, 1) + Chars.Middle(15, 1) + Chars.Middle(48, 1) + Chars.Middle(6, 1) + Chars.Middle(5, 1) + Chars.Middle(9, 1) + Chars.Middle(0, 1) + Chars.Middle(46, 1) + Chars.Middle(12, 1) + Chars.Middle(47, 1) + Chars.Middle(42, 1) + Chars.Middle(3, 1) + Chars.Middle(52, 1) + Chars.Middle(29, 1) + Chars.Middle(8, 1) + Chars.Middle(13, 1) + Chars.Middle(18, 1) + Chars.Middle(54, 1) + Chars.Middle(52, 1) + Chars.Middle(43, 1) + Chars.Middle(18, 1) + Chars.Middle(54, 1) + Chars.Middle(20, 1) + Chars.Middle(30, 1) + Chars.Middle(52, 1) + Chars.Middle(50, 1) + Chars.Middle(53, 1) + Chars.Middle(6, 1) + Chars.Middle(12, 1) + Chars.Middle(47, 1) + Chars.Middle(6, 1) + Chars.Middle(7, 1) + Chars.Middle(24, 1) + Chars.Middle(15, 1) + Chars.Middle(52, 1) + Chars.Middle(35, 1) + Chars.Middle(52, 1) + Chars.Middle(16, 1) + Chars.Middle(26, 1) + Chars.Middle(33, 1) + Chars.Middle(20, 1) + Chars.Middle(6, 1) + Chars.Middle(52, 1) + Chars.Middle(3, 1) + Chars.Middle(33, 1) + Chars.Middle(50, 1) + Chars.Middle(23, 1) + Chars.Middle(13, 1) + Chars.Middle(33, 1) + Chars.Middle(27, 1) + Chars.Middle(12, 1) + Chars.Middle(51, 1) + Chars.Middle(33, 1) + Chars.Middle(49, 1) + Chars.Middle(20, 1) + Chars.Middle(22, 1) + Chars.Middle(18, 1) + Chars.Middle(19, 1) + Chars.Middle(25, 1) + Chars.Middle(53, 1) + Chars.Middle(39, 1) + Chars.Middle(43, 1) + Chars.Middle(41, 1) + Chars.Middle(2, 1) + Chars.Middle(14, 1) + Chars.Middle(21, 1) + Chars.Middle(0, 1) + Chars.Middle(16, 1) + Chars.Middle(14, 1) + Chars.Middle(27, 1) + Chars.Middle(46, 1) + Chars.Middle(44, 1) + Chars.Middle(39, 1) + Chars.Middle(21, 1) + Chars.Middle(53, 1) + Chars.Middle(30, 1) + Chars.Middle(33, 1) + Chars.Middle(3, 1) + Chars.Middle(37, 1) + Chars.Middle(43, 1) + Chars.Middle(38, 1) + Chars.Middle(19, 1) + Chars.Middle(17, 1) + Chars.Middle(44, 1) + Chars.Middle(42, 1) + Chars.Middle(29, 1) + Chars.Middle(21, 1) + Chars.Middle(10, 1) + Chars.Middle(33, 1) + Chars.Middle(29, 1) + Chars.Middle(6, 1) + Chars.Middle(48, 1) + Chars.Middle(33, 1) + Chars.Middle(31, 1) + Chars.Middle(25, 1) + Chars.Middle(53, 1) + Chars.Middle(37, 1) + Chars.Middle(42, 1) + Chars.Middle(46, 1) + Chars.Middle(22, 1) + Chars.Middle(12, 1) + Chars.Middle(21, 1) + Chars.Middle(27, 1) + Chars.Middle(13, 1) + Chars.Middle(34, 1) + Chars.Middle(22, 1) + Chars.Middle(46, 1) + Chars.Middle(1, 1) + Chars.Middle(14, 1) + Chars.Middle(16, 1) + Chars.Middle(39, 1) + Chars.Middle(38, 1) + Chars.Middle(38, 1) + Chars.Middle(42, 1) + Chars.Middle(6, 1) + Chars.Middle(8, 1) + Chars.Middle(38, 1) + Chars.Middle(42, 1) + Chars.Middle(53, 1) + Chars.Middle(11, 1) + Chars.Middle(36, 1) + Chars.Middle(42, 1) + Chars.Middle(52, 1) + Chars.Middle(11, 1) + Chars.Middle(32, 1) + Chars.Middle(36, 1) + Chars.Middle(45, 1) + Chars.Middle(45, 1)),Encodings.UTF8)
		End Function
	#tag EndMethod

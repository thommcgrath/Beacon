...
```http
GET /v4/login?state=0fc732a9-05d8-403c-bdce-231c90f7b924&client_id={{page.sampleClientId}}&scope=common%20users%3Aread&redirect_uri=https%3A%2F%2Fjiinuko.edu%2Fehreg%2Foauth&response_type=code&code_challenge=2b6-gW15O10gZcp97PaXVmmu_4IrMXVBXNWtP8q8crs&code_challenge_method=S256 HTTP/1.1
...
client_id={{page.sampleClientId}}&scope=common%20users%3Aread
```
